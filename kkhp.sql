...
--
-- Host: localhost
-- Generation Time: Oct 27, 2014 at 08:51 AM
...
--
-- Table structure for table `amphur_postcode`
--

CREATE TABLE IF NOT EXISTS `amphur_postcode` (
...
--
-- Dumping data for table `amphur_postcode`
--

INSERT INTO `amphur_postcode` (`AMPHUR_ID`, `POST_CODE`) VALUES
(1, 10200),
(2, 10300),
(2, 10303),
(3, 10530),
...
INSERT INTO `mytable` (`id`, `mystring`) VALUES
(1, 'Hackee'),
(2, 'Hamster'),
(3, 'Hadrosaurus'),
(4, 'Hag-fish'),
...
INSERT INTO `tb_article` (`id_article`, `article_content`) VALUES
(1, 'ข้อมูลกลุ่มงาน'),
(2, 'สื่อการเรียนรู้'),
(3, 'บทความ'),
(4, 'คลังสุขภาพ');
...
CREATE TABLE IF NOT EXISTS `tb_authorization` (
  ...
  `id_tb_person` int(11) NOT NULL,
  `resign` varchar(50) DEFAULT NULL,
  `date_resign` date DEFAULT NULL,
  `date_authorization` date DEFAULT NULL,
  `because_resign` varchar(50) DEFAULT NULL,
  `date_inform_resign` date DEFAULT NULL,
...
INSERT INTO `tb_authorization` (`id_authorization`, `id_tb_person`, `resign`, `date_resign`, `date_authorization`, `because_resign`, `date_inform_resign`, `remark`) VALUES
(7, 5, 'เจ็บป่วย', '2014-02-04', '2014-02-13', 'เปลี่ยนงานใหม่', '2014-02-20', 'กลับบ้าน'),
(6, 3, NULL, NULL, NULL, NULL, NULL, 'จำเป็นต้องเปลี่ยนที่อยู่ใหม่'),
(8, 1, 'เจ็บป่วย', '2014-04-22', '2014-04-30', 'เปลี่ยนงานใหม่', '2014-04-30', 'กลับบ้าน');

-- --------------------------------------------------------

--
-- Table structure for table `tb_content_article`
--

CREATE TABLE IF NOT EXISTS `tb_content_article` (
  `id_content_article` int(11) NOT NULL AUTO_INCREMENT,
  `id_article` int(11) NOT NULL,
  `title` varchar(100) NOT NULL,
  `picture_content_article` varchar(100) DEFAULT NULL,
  `content` text,
  `DMY` datetime DEFAULT NULL,
  `content_enable` int(1) DEFAULT NULL,
  `id_user` int(10) DEFAULT NULL,
  `pin_content` int(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id_content_article`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT AUTO_INCREMENT=19 ;

--
-- Dumping data for table `tb_content_article`
--

INSERT INTO `tb_content_article` (`id_content_article`, `id_article`, `title`, `picture_content_article`, `content`, `DMY`, `content_enable`, `id_user`, `pin_content`) VALUES
(2, 3, 'รู้ไหมว่า .... มะม่วง สาระพัดประโยชน์', 'mango.jpg', '<p>รู้ไหมว่า .... มะม่วง สาระพัดประโยชน์<br />\r\nเมล็ดสด ๆ มารับประทาน หรือนำมาโรยเกลือ รับประทานเพื่อขับปัสสาวะหรือแก้บวมน้ำ เนื้อในเมล็ดใช้แก้ท้องร่วง<br />\r\n<br />\r\nผลมะม่วง นำมาคั้นรับประทานเป็นยาขับปัสสาวะหรือร้อนใน แก้คลื่นไส้ แก้บิดถ่ายเป็นเลือด และใช้เป็นยาบำรุงกระเพาะอาหาร<br />\r\n<br />\r\nใบมะม่วง นำมาพอประมาณต้มรับประทานแก้ซางตานขโมยในเด็ก แก้ลำไส้อักเสบ หรือใช้ใบสดๆ ตำพอกบริเวณที่เป็นแผลสด จะเป็นยาสมานแผลสดได้ดีที่เดียว<br />\r\n<br />\r\nเปลือกลำต้นมะม่วง ใช้เปลือกสดๆ มาต้มรับประทานเป็นยาแก้โรคคอตีบ เยื่อปากอักเสบ จมูกอักเสบ</p>\r\n\r\n<p><a href="https://www.facebook.com/photo.php?fbid=245412345600459&amp;set=a.101175003357528.1334.100003950852257&amp;type=1&amp;relevant_count=1"><img alt="รูปภาพ : รู้ไหมว่า .... มะม่วง สาระพัดประโยชน์\r\nเมล็ดสด ๆ  มารับประทาน หรือนำมาโรยเกลือ รับประทานเพื่อขับปัสสาวะหรือแก้บวมน้ำ เนื้อในเมล็ดใช้แก้ท้องร่วง\r\n\r\nผลมะม่วง นำมาคั้นรับประทานเป็นยาขับปัสสาวะหรือร้อนใน แก้คลื่นไส้ แก้บิดถ่ายเป็นเลือด และใช้เป็นยาบำรุงกระเพาะอาหาร\r\n\r\nใบมะม่วง นำมาพอประมาณต้มรับประทานแก้ซางตานขโมยในเด็ก แก้ลำไส้อักเสบ หรือใช้ใบสดๆ ตำพอกบริเวณที่เป็นแผลสด จะเป็นยาสมานแผลสดได้ดีที่เดียว\r\n\r\nเปลือกลำต้นมะม่วง ใช้เปลือกสดๆ มาต้มรับประทานเป็นยาแก้โรคคอตีบ เยื่อปากอักเสบ จมูกอักเสบ" src="https://fbcdn-sphotos-g-a.akamaihd.net/hphotos-ak-prn2/p480x480/969976_245412345600459_1458406009_n.jpg" style="height:381px; width:504px" /></a></p>\r\n', '2013-05-19 19:04:37', 1, 1, 0),
(3, 3, 'เปลี่ยน LINE ให้เต็มไปด้วยสีชมพู', 'Line.jpg', '<p><strong><a href="http://www.arip.co.th" name="home">[เอ.อาร์.ไอ.พี, www.arip.co.th]</a></strong> เปลี่ยน LINE ให้เต็มไปด้วยสีชมพู ... แอพแชทยอดนิยม LINE ปล่อยอัพเดตอีกครั้ง ซึ่งคราวนี้เอาใจสาวๆ ที่ชอบ หรือกำลังมีความรักด้วยธีมสีชมพู จะเป็นอย่างไรไปติดตามกันเลยจ้าา</p>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p>พื้นที่โฆษณา&nbsp;&nbsp;<img src="http://www.arip.co.th/2006/images/ad/arrow_down.gif" /></p>\r\n\r\n<p>สนใจลงโฆษณา ติดต่อ โทร.0-2642-3400 ต่อ 4613</p>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p><strong>LINE</strong> แอพแชทสุดฮิต เอาใจสาวๆที่ชื่นชอบ และกำลังตกอยู่ในช่วงเวลาแห่งความรักด้วยการปล่อยอัพเดตเวอร์ชัน 3.7.0 บนสมาร์ทโฟนที่เป็น Android ขอย้ำว่า !! เฉพาะ Android เท่านั้น (ในตอนนี้) จุดเด่นหลักคือสามารถเปลี่ยนธีมที่หน้าการใช้งานให้เปลี่ยนเป็น <strong>&quot;สีชมพู&quot; </strong>ได้นอกนั้นก็จะประกอบไปด้วย<br />\r\n<br />\r\n- ธีมที่เปลี่ยนเป็นสีชมพู จะมีตัวการ์ตูนใน LINE บนเมนูต่างๆด้วย<br />\r\n- ใน Official Account มีการเพิ่มโฮมฟังก์ชัน<br />\r\n- ข้อความที่ไม่สามารถส่งได้ จะมีการแจ้งเตือนเข้ามายังผู้ใช้งาน<br />\r\n- รองรับภาษาอิตาเลียน,โปรตุเกส,เยอรมัน<br />\r\n- ทำ QR โค้ดของคุณง่ายต่อการค้นหา<br />\r\n- เพิ่มฟังก์ชั่นภาพใหม่ที่สามารถชมภาพทั้งหมดที่ส่งหรือรับภายในห้องสนทนาของคุณเอง เพียงแตะที่ไอคอน V ที่ด้านบนของแต่ละห้อง</p>\r\n\r\n<p><img alt="" src="http://www.arip.co.th/images/news/2009/%E0%B8%82%E0%B9%88%E0%B8%B2%E0%B8%A7%202013/%E0%B9%81%E0%B8%AD%E0%B8%9E%E0%B8%9E%E0%B8%A5%E0%B8%B4%E0%B9%80%E0%B8%84%E0%B8%8A%E0%B8%B1%E0%B9%88%E0%B8%99%202013/Line%20for%20android%20pink.jpg" style="height:450px; width:263px" /></p>\r\n\r\n<p><img alt="" src="http://www.arip.co.th/images/news/2009/%E0%B8%82%E0%B9%88%E0%B8%B2%E0%B8%A7%202013/%E0%B9%81%E0%B8%AD%E0%B8%9E%E0%B8%9E%E0%B8%A5%E0%B8%B4%E0%B9%80%E0%B8%84%E0%B8%8A%E0%B8%B1%E0%B9%88%E0%B8%99%202013/Line%20for%20android%20pink%202.jpg" style="height:450px; width:263px" /></p>\r\n\r\n<p><img alt="" src="http://www.arip.co.th/images/news/2009/%E0%B8%82%E0%B9%88%E0%B8%B2%E0%B8%A7%202013/%E0%B9%81%E0%B8%AD%E0%B8%9E%E0%B8%9E%E0%B8%A5%E0%B8%B4%E0%B9%80%E0%B8%84%E0%B8%8A%E0%B8%B1%E0%B9%88%E0%B8%99%202013/Line%20for%20android%20pink%203.jpg" style="height:450px; width:254px" /></p>\r\n\r\n<p>ซึ่งผู้ใช้ Android สามารถเข้าไปเลือกธีมดังกล่าวได้ เพียงเข้าไปที่ &gt; Settings &gt; เลือกรายการธีม แล้วกดดาวน์โหลด ก็เป็นอันเสร็จเรียบร้อย ส่วนสาวๆ ใน iOS ก็อย่าเพิ่งเสียใจ เพราะอีกไม่นานก็จะมีอัพเดตออกมาอย่างแน่นอน และในอนาคตก็น่าจะมีธีมอื่นๆมาเอาใจหนุ่มนักแชทด้วยเช่นกันจ้า</p>\r\n', '2013-05-19 19:04:40', 1, 1, 0),
(4, 3, 'อย่าให้คนดีต้องเดินอย่างโดดเดี่ยว', '923082_555658954486136_617739740_n.jpg', '<p><a href="https://www.facebook.com/photo.php?fbid=555658954486136&amp;set=a.139105096141526.33528.100001261100165&amp;type=1&amp;theater#">ติดตาม</a> &middot; 16 พฤษภาคม</p>\r\n\r\n<p><br />\r\nอย่าให้คนดีต้องเดินอย่างโดดเดี่ยวครับ<br />\r\nพวกเราตืนมาช่วยกัน!<br />\r\nไม่เช่นนั้นจะลามถึงทุกคนอย่างเลี่ยงไม่ได้ &mdash; กับ <a href="https://www.facebook.com/cvoranuch">Chatchanok Voranuch</a>, <a href="https://www.facebook.com/somboonc">Somboon Chaisitthiporn</a>, <a href="https://www.facebook.com/pabhavee.bulakul">Pabhavee Bulakul</a> และ<a href="https://www.facebook.com/photo.php?fbid=555658954486136&amp;set=a.139105096141526.33528.100001261100165&amp;type=1&amp;theater#">อีก 45 คน</a></p>\r\n\r\n<p><a href="https://www.facebook.com/photo.php?fbid=555658954486136&amp;set=a.139105096141526.33528.100001261100165&amp;type=1&amp;theater#">ถูกใจ</a> &middot; <a href="https://www.facebook.com/ajax/sharer/?s=2&amp;appid=2305272732&amp;p%5B0%5D=100001261100165&amp;p%5B1%5D=94241287&amp;sharer_type=all_modes">แชร์</a></p>\r\n\r\n<ul>\r\n	<li>&nbsp;</li>\r\n	<li>\r\n	<p><a href="https://www.facebook.com/browse/likes?id=555658954486136">4,111 คน</a> ถูกใจสิ่งนี้</p>\r\n	</li>\r\n	<li>\r\n	<p><a href="https://www.facebook.com/shares/view?id=555658954486136">10,832 shares</a></p>\r\n	</li>\r\n	<li>\r\n	<p><a href="https://www.facebook.com/photo.php?fbid=555658954486136&amp;set=a.139105096141526.33528.100001261100165&amp;type=1&amp;theater#">ดูอีก 33 ความคิดเห็น</a></p>\r\n	</li>\r\n	<li>\r\n	<p><a href="https://www.facebook.com/sbanyong"><img alt="" src="https://fbcdn-profile-a.akamaihd.net/hprofile-ak-prn1/s32x32/572688_100001261100165_1679541091_q.jpg" /></a></p>\r\n\r\n	<p><a href="https://www.facebook.com/sbanyong">คนทำสื่อ ชื่อลุงยงค์</a> ขอบคุณทุกกลังใจที่ให้หมอนะครับ จะทำจดหมายส่งไปให้ท่านครับ</p>\r\n\r\n	<p><a href="https://www.facebook.com/photo.php?fbid=555658954486136&amp;set=a.139105096141526.33528.100001261100165&amp;type=1&amp;comment_id=1834102&amp;offset=0&amp;total_comments=39">วัน วันเสาร์ เวลา 9:20 น.</a> &middot; <a href="https://www.facebook.com/photo.php?fbid=555658954486136&amp;set=a.139105096141526.33528.100001261100165&amp;type=1&amp;theater#">ถูกใจ</a> &middot; <a href="https://www.facebook.com/browse/likes?id=556373014414730">12</a></p>\r\n	</li>\r\n</ul>\r\n', '2013-05-20 20:02:56', 1, 1, 0),
(5, 3, 'ยุงลายเหตุรำคาญ พบแหล่งเพาะพันธุ์ต้องกำจัด', '4_47.jpg', '<h1>ยุงลายเหตุรำคาญ พบแหล่งเพาะพันธุ์ต้องกำจัด</h1>\r\n\r\n<p>โดย pimchanok | วันที่ 20 พฤษภาคม 2556</p>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p><img alt="" src="http://www.thaihealth.or.th/sites/default/files/users/user-15259/4_47.jpg" style="height:145px; width:285px" /></p>\r\n\r\n<p><strong>กรมอนามัย กระทรวงสาธารณสุข เผยประกาศกระทรวงสาธารณสุขเรื่องกำหนดให้แหล่งเพาะพันธุ์ยุงลายเป็นเหตุ รำคาญในพระราชบัญญัติการสาธารณสุขพ.ศ.2535 พร้อมแนวทางการปฏิบัติของเจ้าพนักงานท้องถิ่นเจ้าพนักงานสาธารณสุข และผู้ครอบครองอาคารหากไม่มีการควบคุมและป้องกันแหล่งเพาะพันธุ์ลูกน้ำยุง ลายให้ดำเนินการตามบทลงโทษตามกฎหมายได้ทันที</strong></p>\r\n\r\n<p><strong>นายแพทย์ณรงค์ สายวงศ์ รองอธิบดีกรมอนามัยเปิดเผยถึงแนวทางการควบคุมแหล่งเพาะพันธุ์ยุงลายตามประกาศกระทรวงสาธารณสุข</strong>ว่า จากสถานการณ์การระบาดของโรคไข้เลือดออกที่รุนแรงในขณะนี้เป็นปัญหาสาธารณสุข ที่ต้องป้องกันเฝ้าระวังอย่างเข้มแข็งพร้อมเร่งกำจัดแหล่งเพาะพันธุ์ยุงลาย ในภาชนะหรือเศษวัสดุที่มีน้ำขังและเมื่อมีการตรวจพบลูกน้ำหรือตัวโม่งยุงลาย ถือเป็นเหตุรำคาญ</p>\r\n\r\n<p>ซึ่งราชการส่วนท้องถิ่น เจ้าพนักงานท้องถิ่นและเจ้าพนักงานสาธารณสุขสามารถดำเนินการควบคุมได้ทันที ตั้งแต่ 1. ประชาสัมพันธ์ให้ประชาชนในท้องถิ่นทราบถึงอันตรายของโรคไข้เลือดออกลักษณะ อาการ การควบคุมและป้องกันแหล่งเพาะพันธุ์ยุงลายรวมทั้งผลทางกฎหมายที่กำหนดให้ แหล่งเพาะพันธุ์ยุงลายเป็นเหตุรำคาญ 2. ให้เจ้าพนักงานท้องถิ่นเจ้าพนักงานสาธารณสุขเฝ้าระวังโรคและควบคุมแหล่งเพาะ พันธุ์ยุงลายในเขตท้องที่ที่รับผิดชอบ 3. หากพบว่าอาคารหรือสถานที่ของเอกชนมีแหล่งเพาะพันธุ์ยุงลายให้แจ้งหรือแนะนำ ให้เจ้าของหรือผู้ครอบครองอาคารหรือสถานที่นั้นปรับปรุงแก้ไขและ 4. หากเจ้าของหรือผู้ครอบครองอาคารไม่ให้ความร่วมมือหรือไม่ปรับปรุงแก้ไขตามคำ แนะนำให้เจ้าพนักงานท้องถิ่นออกคำสั่งตามมาตรา28 ให้ปรับปรุงแก้ไขภายในระยะเวลาที่กำหนดหากฝ่าฝืนไม่ปฏิบัติตามจะมีบทลงโทษ โดยปรับไม่เกิน 2,000 บาทหรือจำคุกไม่เกินหนึ่งเดือน หรือทั้งจำทั้งปรับได้ตามมาตรา 74</p>\r\n\r\n<p>นายแพทย์ณรงค์ กล่าวต่อไปว่ากรณีที่ตรวจพบแหล่งเพาะพันธุ์ยุงลายในที่หรือทางสาธารณะเจ้า พนักงานท้องถิ่นสามารถดำเนินการได้ทันทีหากทราบว่าแหล่งเพาะพันธุ์ยุงลาย นั้นเกิดจากการกระทำของบุคคลใดให้ออกคำสั่งตามมาตรา27 ให้บุคคลนั้นปรับปรุงแก้ไขตามระยะเวลาที่กำหนดถ้าไม่ปฏิบัติตามให้ท้องถิ่น สั่งการให้ดำเนินการลงโทษตามบทบัญญัติมาตรา74 ข้างต้นได้เช่นกันแต่หากไม่ปรากฏว่าเกิดจากบุคคลใดให้เจ้าพนักงานท้องถิ่น สั่งการให้เจ้าหน้าที่สาธารณสุขของท้องถิ่นดำเนินการทำลายแหล่งเพาะพันธุ์ นั้นได้โดยการถมระบายน้ำ ทิ้ง คว่ำ หรือใส่สารเคมีกำจัดลูกน้ำ แล้วแต่กรณีที่เหมาะสม</p>\r\n\r\n<p>ส่วนกรณีที่เป็นอาคารรกร้างว่างเปล่าหรือก่อสร้างไม่เสร็จโดยไม่ปราก ฎเจ้าของชัดเจนและเป็นแหล่งเพาะพันธุ์ยุงลายให้ราชการส่วนท้องถิ่นดำเนินการ ทำลายแหล่งพันธุ์ยุงลายนั้นได้เพราะหากมีการเฝ้าระวังที่ดีจะป้องกันไข้ เลือดออกไม่ให้แพร่ระบาดได้โดยอาจไม่ต้องใช้มาตรการกฎหมาย&quot;วิธีการตรวจและ เฝ้าระวังแหล่งเพาะพันธุ์ยุงลายนั้นสามารถดำเนินการได้โดยประชาชนอาจให้ความ ร่วมมือในการตรวจดูภาชนะหรือเศษวัสดุที่มีน้ำขังทั้งในหรือนอกอาคารว่ามีลูก น้ำหรือตัวโม่งยุงลายหรือไม่ซึ่งจากสถิติทั่วไปพบว่าลูกน้ำในภาชนะหรือเศษ วัสดุที่มีน้ำขังจะเป็นลูกน้ำยุงลายร้อยละ 95 ขึ้นไปหากพบว่ามีลูกน้ำหรือตัวโม่งให้ประชาชนเทน้ำทิ้งและเปลี่ยนน้ำในภาชนะ ทุกๆ 7 วันก็จะเป็นการป้องกันมิให้เกิดแหล่งเพาะพันธุ์ยุงลายในครัวเรือนและชุมชน ได้</p>\r\n\r\n<p>นอกจากนี้ การดำเนินการเมื่อเปิดภาคเรียนควรมีการคัดกรองหรือวัดไข้เด็กหากพบว่าเด็ก นักเรียนมีไข้ร่วมกับไอหรือเจ็บคอให้สวมหน้ากากอนามัยแต่หากมีเพียงอาการไข้ อย่างเดียว ให้สงสัยอาจเป็นไข้เลือดออกควรแนะนำให้ทายากันยุงเพื่อลดการแพร่เชื้อจากผู้ ป่วยไปสูยุงและยุงกัดเด็กคนอื่นและให้นักเรียนแกนนำสุขภาพแจ้งการป่วยของ เพื่อนนักเรียน ควรปลูกตะไคร้หอมเพื่อใช้สำหรับกันยุงในห้องเรียน</p>\r\n\r\n<p>และขอความร่วมมือให้นักเรียนแกนนำสุขภาพรณรงค์ควบคุมลูกน้ำยุงลายเป็น ประจำสัปดาห์ละ 1 ครั้ง โดยเฉพาะสัปดาห์ที่มีฝนตก ควรกำจัดขยะและภาชนะเหลือใช้ที่จะกลายเป็นแหล่งเพาะพันธุ์ยุงลายภายใน 7 วัน ที่สำคัญการนอนกลางวันของเด็กในศูนย์เด็กเล็กควรตรวจดูมุ้งลวดของอาคารศูนย์ เด็กเล็กไม่ให้ชำรุดหากไม่ได้อยู่ในห้องที่มีมุ้งลวด ควรให้เด็กนอนในมุ้งและแนะนำผู้ปกครองให้ดูแลเด็กที่นอนกลางวันในบ้าน โดยให้นอนกางมุ้งเพื่อป้องกันยุงกัด&quot; รองอธิบดีกรมอนามัย กล่าวในที่สุด</p>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p><strong>ที่มา : </strong>กรมอนามัย</p>\r\n', '2013-05-20 20:02:58', 1, 1, 0),
(6, 3, 'ไส้กรอก" ตวงขายตามน้ำหนัก เสี่ยงไม่ปลอดภัย', 'printed 3d baby.jpeg', '<h1>&quot;ไส้กรอก&quot; ตวงขายตามน้ำหนัก เสี่ยงไม่ปลอดภัย</h1>\r\n\r\n<p>โดย pimchanok | วันที่ 20 พฤษภาคม 2556</p>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p><img alt="" src="http://www.thaihealth.or.th/sites/default/files/users/user-15259/1_68.jpg" style="height:145px; width:285px" /></p>\r\n\r\n<p><strong>นายอินทาวุธ สรรพวรสถิตย์ อาจารย์ประจำภาควิชาเทคโนโลยีทางอาหาร คณะวิทยาศาสตร์ จุฬาลงกรณ์มหาวิทยาลัย กล่าวว่า ปัจจุบันอาหารประเภทไส้กรอกได้รับความนิยมสูง เพราะรับประทานง่าย และราคาไม่แพงนัก อย่างไรก็ตาม มักจะมีคำถามมากมายในเรื่องการรับประทานไส้กรอกว่า มีส่วนผสมอะไรบ้าง รับประทานแล้วปลอดภัยต่อสุขภาพหรือไม่ และควรเลือกรับประทานไส้กรอกชนิดใดจึงจะปลอดภัย</strong></p>\r\n\r\n<p>ซึ่งจากการศึกษาและรวบรวมข้อมูลผลิตภัณฑ์ไส้กรอกในประเทศไทยพบว่า จุดแรกของการเลือกซื้อไส้กรอกมารับประทาน จะต้องดูจากบรรจุภัณฑ์ว่าได้รับมาตรฐานความปลอดภัยจากสำนักงานคณะกรรมการ อาหารและยา (อย.) หรือไม่ ที่สำคัญต้องระมัดระวังไส้กรอกที่วางขายอยู่ตามท้องตลาด โดยเฉพาะไส้กรอกที่ตวงขายตามน้ำหนัก เพราะไม่มีฉลากบอกรายละเอียดของผลิตภัณฑ์ ดังนั้น ควรเลือกซื้อไส้กรอกที่บรรจุถุง หรือในบรรจุภัณฑ์ที่มีฉลากบอกรายละเอียดของผลิตภัณฑ์และการรับรองจาก อย.</p>\r\n\r\n<p>นายอินทาวุธกล่าวอีกว่า สำหรับส่วนประกอบของไส้กรอกที่มีข้อกังวลว่า จะส่งผลต่อสุขภาพหรือไม่ อย่างสารไนเตรทและไนไตรท์ ซึ่งจะทำให้ไส้กรอกมีสีชมพู มีกลิ่นและรสชาติเฉพาะ รวมทั้งยังช่วยป้องกันการเติบโตของจุลินทรีย์ ที่จะสร้างสารโบทูลินัม ทอกซิน หรือที่เรียกกันว่าโบท็อกซ์ ถ้าผู้บริโภครับประทานในปริมาณที่มากเกินไป จะทำให้อวัยวะภายในเกิดอัมพาตชั่วคราวได้</p>\r\n\r\n<p>ดังนั้น การเลือกซื้อไส้กรอกผู้บริโภคควรสังเกตจากสีของไส้กรอก โดยเลือกสีที่ใกล้เคียงธรรมชาติที่สุด ขณะที่บรรจุภัณฑ์ต้องปิดมิดชิด มีเครื่องหมาย อย. วันหมดอายุอย่างชัดเจน อย่างไรก็ตาม กระทรวงสาธารณสุขมีกฎหมายควบคุมการเติมสารกลุ่มไนเตรทและไนไตรท์ในปริมาณ เล็กน้อย เพียงพอที่จะป้องกันการเจริญเติบโตของเชื้อจุลินทรีย์ดังกล่าว หากเลือกซื้อไส้กรอกที่ได้มาตรฐานก็จะสร้างความมั่นใจได้ว่า ปลอดภัยในการบริโภค</p>\r\n\r\n<p>ผู้สื่อข่าวถามว่า เด็กคนที่อยู่ระหว่างลดน้ำหนัก และผู้ป่วยควรบริโภคไส้กรอกหรือไม่ นายอินทาวุธกล่าวว่า ไส้กรอกคือ อาหารโปรตีนชนิดหนึ่ง มีส่วนประกอบ คือ เกลือ ไขมัน ซึ่งเด็กรับประทานได้ แต่หลักการรับประทานอาหารต้องไม่ทานอาหารชนิดเดียวกันซ้ำกันนานเกินไป ส่วนผู้ที่อยู่ระหว่างการลดน้ำหนัก ต้องพิจารณาจากปริมาณพลังงานจากอาหาร แต่ละอย่างที่รับประทานแต่ละวัน เช่น หากรับประทานไส้กรอกแล้ว ยังรับประทานข้าว หรือแป้งชนิดอื่นๆ เข้าไปอีก ก็อาจน้ำหนักขึ้นได้ ส่วนผู้ป่วยขึ้นอยู่กับป่วยเป็นโรคอะไร และแพทย์ให้จำกัดอาหารชนิดใดเป็นต้น</p>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p><strong>ที่มา :</strong> หนังสือพิมพ์มติชน</p>\r\n', '2013-05-20 20:03:14', 1, 1, 0),
(7, 4, 'ปล่อยคาราวานรถปลอดภัยประจำจุดเสี่ยง 28 แห่งระวังเด', '14.jpg', '<h1>ปล่อยคาราวานรถปลอดภัยประจำจุดเสี่ยง 28 แห่งระวังเด็กตีกัน</h1>\r\n\r\n<p>โดย gidanan ganghair | วันที่ 17 พฤษภาคม 2556</p>\r\n\r\n<p><strong><img alt="" src="http://www.thaihealth.or.th/sites/default/files/users/user-16058/556000006129903.jpeg" style="height:145px; width:285px" /></strong></p>\r\n\r\n<p><strong>ศธ.จับมือเครือข่ายเฝ้าระวังเหตุ เด็กทะเลาะวิวาท พร้อมปล่อยคาราวานรถปลอดภัยดูแล 28 จุดเสี่ยง รอบกรุงเทพและปริมณฑล ย้ำต้องไม่ปล่อยให้การวิวาทเป็นเรื่องธรรมดาของสังคมไทย</strong></p>\r\n\r\n<p><strong>นายพงศ์เทพ เทพกาญจนา รัฐมนตรีว่าการกระทรวงศึกษาธิการ </strong>เป็น ประธานในพิธีปล่อยขบวนรถยนต์ปฎิบัติการศูนย์เสมารักษ์ ในโครงการ &ldquo;ไปเรียนปลอดภัย&rdquo; ของสำนักการลูกเสือ ยุวกาชาดและกิจการนักเรียน พร้อมกล่าวว่า จากข้อมูลและสถิติของสำนักงานลูกเสือและหน่วยงานที่เกี่ยวข้องกับการแก้ ปัญหาก่อเหตุทะเลาะวิวาทของนักเรียนพบว่า จะมีการก่อเหตุบ่อยครั้งในช่วงเปิดภาคเรียนและช่วงเวลาก่อนและหลังเลิกเรียน เป็นอันตรายต่อการเดินทางไปกลับโรงเรียนของนักเรียน นักศึกษาทั่วไป เพราะฉะนั้น ศธ.จะได้จัดโครงการดังกล่าวขึ้นเพื่อประสานความร่วมมือระหว่างหน่วยงานต่างๆ ทั้ง กระทรวงศึกษาธิการ สถานีตำรวจนครบาล องค์การขนส่งมวลชนกรุงเทพ (ขสมก.) และศูนยเสมารักษ์ เพื่อเฝ่าระวังจุดเสี่ยง 28 จุด ใน 5 โซนครอบคลุม กทม.และปริมณฑล รวมถึงจะมีการจัดหน่วยเครือข่ายเคลื่อนที่เร็ว เพื่อเข้าระงับเหตุเมื่อมีการก่อเหตุทะเลาะวิวาทด้วย</p>\r\n\r\n<p>&ldquo; เรื่องความปลอดภัยเด็กเป็นเรื่องที่ผู้ปกครองให้ความสำคัญ เพราะไม่มีใครอยากเห็นบุตรหลานของตนเองบาดเจ็บหรือเกิดอุบัติเหตุ ที่ผ่านมามีเหตุการณ์เกิดขึ้นจากความขัดแย้งของนักศึกษา ซึ่งถึงแม้เป็นกลุ่มน้อยแต่ทำให้เกิดผลกระทบไปถึงผู้บริสุทธิ์จำนวนมาก จึงไม่อยากเห็นเหตุการณ์แบบนี้เกิดขึ้นอีก เพราะทำให้สถาบันเสียชื่อเสียงไปด้วย ดังนั้นทุกฝ่ายจะต้องมาร่วมมือกันป้องกันและเฝ้าระวังเพื่อไม่ให้เหตุการณ์ ทะเลาะวิวาทของเด็กกลายเป็นเรื่องปกติของสังคมไทย&rdquo; นายพงศ์เทพ กล่าว</p>\r\n\r\n<p><strong>ด้านนายศุภกรณ์ วงศ์ปราชญ์ รองปลัด ศธ.</strong>กล่าวว่า จากข้อมูลสถิติของสำนักลูกเสือฯและหน่วยงานที่เกี่ยวข้องพบว่า ปัญหาการทะเลาะวิวาทของนักเรียนนักศึกษาส่วนใหญ่จะเป็นระดับอาชีวศึกษา และช่วงเวลาก่อเหตุจะอยู่ในช่วงเปิดภาคเรียนที่ 1 ของปีการศึกษา ก่อนเข้าโรงเรียนและเวลาหลังเลิกเรียนไปจนถึงเวลา 20.30 น.โดยเฉพาะจุดเสี่ยงที่เกิดเหตุ ได้แก่ ป้ายรถประจำทาง ห้างสรรพสินค้า และบริเวณหน้าสถานศึกษา จึงมีการดำเนินโครงการจัดทำแผนปฎิบัติงานแบ่งพื้นที่ออกเป็น5 โซน พร้อมกำหนดจุดเสี่ยงสำคัญเพื่อเฝ้าระวังตั้งแต่วันที่ 16 พ.ค.-20 มิ.ย.ในเขตพื้นที่กรุงเทพมหานครและปริมณฑล</p>\r\n\r\n<p>&nbsp;สำหรับจุดเสี่ยงในเขตกรุงเทพมหานครและปริมณฑล 28 แห่ง ได้แก่ 1.หน้าห้างสรรพสินค้าพาต้าปิ่นเกล้า 2.แยกสวนมิกสักวัน 3.สี่แยกปทุมวัน 4.ป้ายรถประจำทางวิทยาลัยเทคโนโลยีสยาม 5.ป้ายรถประจำทางหน้าโรงเรียนบางปะกอกวิทยาคม 6.ตลอดบางแค 7.ป้ายรถประจำทางหน้าวิทยาลัยวิบูลบริหารธุรกิจสี่แยกท่าพระ 8.ตลาดอ้อมน้อยสี่แยกพุทธมนฑลสาย5 9.วงแหวนเอกชัย-บางบอน 10.สามแยกราษฎร์บูรณะ มหาวิทยาลัยราชมงคลธนบุรี 11.ตลาดมีนบุรี 12.ตลาดหนอกจอก 13.ศูนย์การค้าแฟชั่นไอส์แลนด์ ถนนรามอินทรา 14.ซอยมิสทีน ถนนสุขาภิบาล 3 15.ศูนย์การค้าเดอะมอลล์บางกะปิ 16.ป้ายรถประจำทางหน้าวัดดอนเมือง 17.สถานีรถไฟดอนเมือง 18.ป้ายรถประจำทางหน้าเซ็นทรัลรามอินทรา 19.อู่รถประจำทาง หน้าวัดพระศรีมหาธาตุ 20.ตลาดสะพานใหม่ดอนเมือง 21.หน้าโรงเรียนไทยวิจิตรศิลป์ 22.สี่แยกเกษตรศาสตร์ 23.หน้าเซ็นทรัลลาดพร้าว 24.แยกบางนา 25.ห้างสรรพสินค้าเซ็นทรัลบางนา 26.หน้าโรงเรียนปทุมคงคา 27.ห้างสรรพสินค้าอิมพีเรียลสำโรง และ 28.ตลาดปากน้ำ</p>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p><strong>ที่มา :</strong> หนังสือพิมพ์ ASTV ผู้จัดการ</p>\r\n', '2013-05-20 20:03:16', 1, 1, 0),
(8, 3, 'iPhone 5S จะเพิ่มความละเอียดหน้าจอ', 'iphone5s.jpg', '<p><strong><a href="http://www.arip.co.th" name="home">[เอ.อาร์.ไอ.พี, www.arip.co.th]</a></strong> iPhone 5S จะเพิ่มความละเอียดของจอแสดงผล ... เป็นข่าวรายวันจริงๆสำหรับอุปกรณ์รุ่นใหม่ของ Apple อย่าง iPhone 5S ที่มีการคาดหมายกันไว้ว่ามันจะเป็นฮาร์ดแวร์รุ่นใหม่ในตระกูล iPhone ตัวแรกที่เปิดตัวในปีนี้ พร้อมกับหลายสิ่งหลายอย่างที่เพิ่มขึ้นมาใน iPhone 5S</p>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p>พื้นที่โฆษณา&nbsp;&nbsp;<img src="http://www.arip.co.th/2006/images/ad/arrow_down.gif" /></p>\r\n\r\n<p>สนใจลงโฆษณา ติดต่อ โทร.0-2642-3400 ต่อ 4613</p>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p><img alt="" src="http://www.arip.co.th/images/news/2009/%E0%B8%82%E0%B9%88%E0%B8%B2%E0%B8%A7%202013/Apple%202013/new%20retina%20display%20iphone%205s.jpg" style="height:313px; width:500px" /></p>\r\n\r\n<p>เว็บไซต์ WeiPhone ของจีนได้รายงานว่า Apple กำลังมีความพยายามในการเพิ่มความละเอียดของหน้าจอแสดงผลใน<strong> iPhone 5S</strong> ให้มากกว่าจอ<strong> Retina Display </strong>บน <strong>iPhone 5</strong> ซึ่งจะมีการเพิ่มจำนวนพิกเซลจากเดิม 730,000 เป็น 1.5 ล้านพิกเซล ทำให้มีความหนาแน่นของพิกเซลบนหน้าจอขนาด 4 นิ้วนั้นมากขึ้น แหล่งข่าวยังระบุว่าการเพิ่มความละเอียดบนหน้าจอ iPhone 5S ทาง Apple อาจใช้เทคนิคเดียวกับที่ใช้ใน iPad mini ด้วยการขยายขอบจอแสดงผลให้ติดกับขอบตัวเครื่องมากขึ้น หากเป็นไปอย่างที่เว็บไซต์จีนอ้างไว้ก็อาจทำให้นักพัฒนาแอพพลิเคชั่นบน iOS ต้องรับภาระในการปรับความละเอียดของการแสดงผลให้เข้ากับจอแสดงผลใหม่ของ iPhone 5S<br />\r\n<br />\r\nจากข้อมูลดังกล่าวทำให้คิดได้ว่าการมาของสมาร์ทโฟนรุ่น ใหม่ๆ ที่ปรับความละเอียดของการแสดงผลมาที่ 1080p ส่งผลต่อ Apple พอสมควร การมีจอแสดงผลระดับ Retina Display ที่ให้ความคมชัดชนิดที่สายตาแทบแยกไม่ออกแล้วเป็นตัวชูโรงอาจไม่พอสำหรับ Apple อีกต่อไป ดังนั้นความเปลี่ยนแปลงที่จะมากับ iPhone 5S จึงเป็นสิ่งที่ Apple ต้องการทิ้งห่างคู่แข่งรายอื่นๆออกไป</p>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p><br />\r\n<strong>Tags:</strong> <a href="http://www.arip.co.th/tag/iphone+5s" target="_blank">iphone 5s</a> <a href="http://www.arip.co.th/tag/retina+display" target="_blank">retina display</a> <a href="http://www.arip.co.th/tag/apple" target="_blank">apple</a> <a href="http://www.arip.co.th/tag/iphone" target="_blank">iphone</a> <a href="http://www.arip.co.th/tag/%E0%B8%82%E0%B9%88%E0%B8%B2%E0%B8%A7%E0%B9%84%E0%B8%AD%E0%B8%97%E0%B8%B5" target="_blank">ข่าวไอที</a> <a href="http://www.arip.co.th/tag/arip" target="_blank">arip</a></p>\r\n', '2013-05-20 20:03:18', 1, 1, 0);
INSERT INTO `tb_content_article` (`id_content_article`, `id_article`, `title`, `picture_content_article`, `content`, `DMY`, `content_enable`, `id_user`, `pin_content`) VALUES
(9, 3, 'เตือนระวังไข้ปวดข้อ “ชิคุนกุนยา” ระบาดพร้อมไข้เลือ', 'medmed01001.gif', '<h1>เตือนระวังไข้ปวดข้อ &ldquo;ชิคุนกุนยา&rdquo; ระบาดพร้อมไข้เลือดออก</h1>\r\n\r\n<p>โดย gidanan ganghair | วันที่ 17 พฤษภาคม 2556</p>\r\n\r\n<p><strong><img alt="" src="http://www.thaihealth.or.th/sites/default/files/users/user-16058/medmed01001.gif" style="height:145px; width:285px" /></strong></p>\r\n\r\n<p><strong>สธ.เตือนประชาชนระวังโรคไข้ปวดข้อ ยุงลายหรือ โรคชิคุนกุนยาจะกลับมาระบาดพร้อมโรคไข้เลือดออก หลังผลวิจัยพบว่าในหลายพื้นที่โดยเฉพาะ สตูล ชุมพร ตรัง สุราษฏร์ธานี ชลบุรี ฉะเชิงเทรา ยุงลายสวนติดเชื้อชิคุนกุนยาสูงถึงร้อยละ 39 ยุงบางตัวมีทั้งเชื้อไวรัสเดงกีและเชื้อไวรัสชิคุนกุนยาอยู่ในตัวเดียว และพบว่าไม่จำเป็นว่ายุงต้องไปกัดผู้ป่วยแล้วจึงจะมีเชื้อ วิธีป้องกันโรคได้ดีที่สุดคือการกำจัดแหล่งเพาะพันธุ์ยุงลายและการป้องกัน ไม่ให้ยุงกัด ทั้งกลางวันและกลางคืน</strong></p>\r\n\r\n<p><strong>นพ.นิพนธ์ โพธิ์พัฒนชัย อธิบดีกรมวิทยาศาสตร์การแพทย์</strong> เปิดเผยผลการวิจัย ของกรมวิทยาศาสตร์การแพทย์ กระทรวงสาธารณสุข ร่วมกับ คณะแพทยศาสตร์ จุฬาลงกรณ์มหาวิทยาลัย พบว่าในหลายพื้นที่โดยเฉพาะจังหวัดสตูล ชุมพร ตรัง สุราษฏร์ธานี ชลบุรี ฉะเชิงเทรา ยุงลายสวนติดเชื้อไวรัสชิคุนกุนยา (Chikungunya virus) สูงถึงร้อยละ 39 ยุงบางตัวติดเชื้อไวรัสทั้งสองชนิด ได้แก่ เชื้อไวรัสเดงกี (Dengue virus) ซึ่งทำให้เกิดไข้เลือดออก และเชื้อไวรัสชิคุนกุนยา หรือไข้ปวดข้อยุงลาย นอกจากนี้ความรู้ จากการวิจัยยังพบว่าไม่จำเป็นว่ายุงต้องไปกัดผู้ป่วยแล้วจึงจะมีเชื้อ และเชื้อไวรัสทั้งสองชนิดนี้ยังสามารถถ่ายทอดจากแม่ยุงไปยังลูกยุงได้ด้วย</p>\r\n\r\n<p>วิธีการป้องกันโรคได้ดีที่สุดคือการกำจัดแหล่งเพาะพันธุ์ยุงลาย ซึ่งส่วนใหญ่จะอยู่ในบริเวณบ้าน เช่น โอ่งเก็บน้ำฝนไม่มีฝาปิด อ่างเก็บน้ำในห้องน้ำ จานรองขาตู้กับข้าว แจกันบูชาพระ กระป๋อง ถ้วยน้ำหรือ แก้วพลาสติกที่ทิ้งไม่เป็นที่เป็นทางและมีน้ำขัง เศษขยะ กล่องโฟม รวมถึงยางรถยนต์เก่า เป็นต้น ด้วยวิธี การง่ายๆ เช่น คว่ำหรือปิดฝาภาชนะดังกล่าวให้สนิท ตรวจรอบๆ บ้านว่ามีแหล่งน้ำขังหรือไม่ หากมีต้องกำจัดการเก็บกวาดสิ่งปฏิกูลออกไป และอีกทางหนึ่งคือการป้องกันไม่ให้ยุงกัดทั้งกลางวันและกลางคืน ซึ่งแต่เดิมเข้าใจว่ายุงลายกัดเฉพาะเวลากลางวัน แต่ผลการวิจัยพบว่าปัจจุบันในบ้านเรายุงลายกัดไม่เลือกเวลา ปรับตัวตามพฤติกรรม ของคน และพบว่าอุณหภูมิบนยอดดอย ที่สูงขึ้นทำให้ยุงลายกัดบ่อยขึ้นและขยายพันธุ์ได้บนภูเขาสูง ต่างจากความรู้เดิมที่ว่ายุงลายบ้านไม่สามารถขยายพันธุ์ได้บนที่สูงเกิน 350 เมตร ดังนั้นอาจจะทำให้เกิดการระบาดของไข้ปวดข้อยุงลายและไข้เลือดออกในหมู่ชาว ดอย เพราะไม่เคยมีภูมิคุ้มกันมาก่อน</p>\r\n\r\n<p>นพ.นิพนธ์ กล่าวต่อว่า การป้องกันการกัดของยุง นอกจากใส่เสื้อผ้ามิดชิดแล้ว ต้องชโลม ยาทากันยุงให้ทั่วส่วนที่โผล่พ้นเสื้อผ้า เพราะกลไกการป้องกันยุงของสารทาป้องกันยุงที่สำคัญ คือ ปกป้องบริเวณที่ทาไม่ให้ยุงหาเป้าหมายเจอ ส่วนบริเวณผิวหนังใกล้เคียงซึ่งไม่ได้ทายาจะไม่ถูกปกป้อง ซึ่งสารออกฤทธิ์ที่ป้องกันยุงกัดได้ดีที่สุดและมีอายุการใช้งานยาวนานในการ เก็บมากที่สุดจนถึงขณะนี้คือ สารดีทหรือ ไดเอททิล โทลูเอไมด์ ที่มีความเข้มข้นร้อยละ 15-30 โดยน้ำหนัก ซึ่งจะป้องกันการกัดของยุงทั้งกลางวันและกลางคืนได้ 4-7 ชั่วโมงขึ้นอยู่กับตำรับ บุคคล และสิ่งแวดล้อมบริเวณที่ใช้ องค์การอนามัยโลกจึงแนะนำให้ใช้ป้องกันโรค ที่ระบาดโดยแมลง รองลงมาจากดีท คือ สารออกฤทธิ์ที่เหมาะสำหรับใช้กับเด็กเล็กต่ำกว่าสี่ขวบ ซึ่งเป็นสารสังเคราะห์เลียนแบบกรดอะมิโนจากธรรมชาติ คือ ไออาร์ 3535 หรือเอททิลบิวทิลอะซิติลอะมิโนโปรปิโอเนท โดยองค์กรพิทักษ์สิ่งแวดล้อมแห่งประเทศสหรัฐอเมริกา (United States Environmental Protection Agency) หรือยูเอสอีพีเอ อนุญาตให้ใช้ในเด็กได้ตั้งแต่อายุหกเดือน แต่ในประเทศไทย โดยสำนักงานคณะกรรมการอาหารและยา (อย.) ให้ใช้ได้ตั้งแต่สองขวบขึ้นไป</p>\r\n\r\n<p>สำหรับน้ำมันหอมระเหยจากสมุนไพรต้องทาซ้ำทุกครึ่งชั่วโมง สำหรับป้องกันการกัดของยุงลายหรือ ยุงน้ำกร่อย และทาซ้ำทุก 2-3 ชั่วโมง สำหรับการป้องกันการกัดของยุงกลางคืน ทั้งนี้ขึ้นอยู่กับตำรับ ที่แต่ละแหล่งผลิต และในการใช้ผลิตภัณฑ์ทาป้องกันยุงหากรู้สึกร้อนผิวให้ล้างออกด้วยสบู่และน้ำ สะอาด และเปลี่ยนไปใช้ผลิตภัณฑ์แผ่นไล่ยุงชนิดแมท ซึ่งใช้คู่กับอุปกรณ์เสียบไฟฟ้า เนื่องจากบางคนผิวจะไวต่อการแพ้ แต่ควรใช้ในที่ซึ่งอากาศถ่ายเทได้ ซึ่งจะปกป้องการกัดได้ประมาณร้อยละ 80-90</p>\r\n\r\n<p><strong>นพ.สมชาย แสงกิจพร ผู้อำนวยการสถาบันวิจัยวิทยาศาสตร์สาธารณสุขกรมวิทยาศาสตร์การแพทย์ </strong>กล่าว เพิ่มเติมว่า การเฝ้าระวังระดับพันธุกรรมของเชื้อไวรัสชิคุนกุนยา พบว่าขณะนี้มีทั้งสายพันธุ์แอฟริกาที่กลายพันธุ์และสายพันธุ์เอเชียดั้งเดิม คนไทยบางคนและนักท่องเที่ยว ส่วนใหญ่ที่ยังไม่มีภูมิคุ้มกันต่อเชื้อไวรัสชิคุนกุนยา จึงเสี่ยงต่อการป่วยด้วยโรคนี้ แม้ว่าจะไม่ทำให้ตายเหมือนไข้เลือดออก แต่ความทรมานจากการปวดข้อรุนแรงและไม่หายขาด บางรายปวดข้อเป็นปีก็ยังไม่หายและ แม่ที่กำลังตั้งครรภ์ที่ได้รับเชื้อสามารถถ่ายทอดไปสู่ทารกได้ ทำให้ทารกเกิดใหม่มีไข้ มีผื่น ไม่ค่อยขยับตัว และหายใจเร็ว ต้องการการดูแลเป็นพิเศษ จึงไม่ควรซื้อยามารับประทานเอง แต่ให้ไปที่สถานบริการสาธารณสุข จะได้เข้าสู่ระบบการเฝ้าระวังโรคและให้การรักษาที่ถูกต้อง</p>\r\n\r\n<p>เนื่องจากอาการของโรคไข้ปวดข้อยุงลายหรือโรคชิคุนกุนยามีลักษณะคล้ายกับ โรคไข้เลือดออก การตรวจรักษาของแพทย์จำเป็นต้องอาศัยผลการตรวจชันสูตรทางห้องปฏิบัติการ เพื่อเป็นเครื่องมือยืนยันว่าผู้ป่วยเป็นโรคอะไร กรมวิทยาศาสตร์การแพทย์ ได้พัฒนาศักยภาพระบบการตรวจวิเคราะห์เชื้อไวรัส ชิคุนกุนยาและเชื้อไวรัสเดงกีทางห้องปฏิบัติการ รวมทั้งดำเนินการเฝ้าระวังโรคทางห้องปฏิบัติการ ทั้งในส่วนกลางและส่วนภูมิภาค ให้สามารถรายงานผล ได้อย่างรวดเร็วและมีความถูกต้อง แม่นยำ โดยเฉพาะ ในรายเร่งด่วนสามารถตรวจวิเคราะห์และรายงานผลได้ภายใน 24 ชั่วโมง ซึ่งเป็นผลดีต่อแนวทางการรักษาผู้ป่วยและการควบคุมโรคได้อย่างมีประสิทธิภาพ มากยิ่งขึ้น ดังนั้น โรงพยาบาลของรัฐหรือเอกชนทั่วประเทศ สามารถส่งตัวอย่างของผู้ป่วยมาตรวจวิเคราะห์ได้ที่ สถาบันวิจัยวิทยาศาสตร์สาธารณสุข กรมวิทยาศาสตร์การแพทย์หรือในส่วนภูมิภาคส่งตรวจได้ที่ศูนย์วิทยาศาสตร์การ แพทย์ 14 แห่งทั่วประเทศ ได้แก่ เชียงใหม่ เชียงราย พิษณุโลกนครสวรรค์ สมุทรสงคราม ชลบุรี ขอนแก่น อุดรธานี นครราชสิมา อุบลราชธานี สุราษฏร์ธานี ภูเก็ต สงขลา และตรัง</p>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p><strong>ที่มา : </strong>หนังสือพิมพ์ ASTVผู้จัดการ</p>\r\n', '2013-05-20 20:03:18', 1, 1, 0),
(11, 3, 'ภูมิแพ้อาหาร', 'htc.jpg', '<p><strong>ภูมิแพ้อาหาร</strong></p>\r\n\r\n<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>การแพ้อาหาร</strong> ถือเป็นโรคภูมิแพ้ประเภทหนึ่งที่พบมาก&nbsp; นอกเหนือจากโรคภูมิแพ้ผิวหนัง&nbsp; แพ้อากาศ&nbsp; หรือหอบหืด&nbsp; มีรายงานจากสหรัฐอเมริกา&nbsp; พบว่า &nbsp;ประชากรมากกว่า ๑๒ ล้านคนเป็นโรคภูมิแพ้อาหารและเกิดขึ้นในเด็กประมาณ ๓ ล้านคน&nbsp;&nbsp; จึงเห็นได้ว่าโรคนี้เกิดขึ้นมานานหลายสิบปี&nbsp; และมีแนวโน้มเพิ่มขึ้นเรื่อย ๆ ทั้งเด็กและผู้ใหญ่&nbsp;&nbsp; เนื่องจากการการใช้ชีวิตและสิ่งแวดล้อมรอบ ๆ ตัวที่เปลี่ยนแปลงไป&nbsp;&nbsp;&nbsp; สำหรับประเทศไทยมีแนวโน้มเด็กเป็นภูมิแพ้อาหารเพิ่มมากขึ้นจากอาหารบางชนิด&nbsp; ได้แก่&nbsp; นมวัว&nbsp; ไข่&nbsp; และแป้งสาลี&nbsp; โดยเฉพาะขวบปีแรกอาจมีระดับการแพ้สูงขึ้นช่วงระยะหนึ่ง&nbsp; แต่หลังจาก ๒ - ๓ ขวบจะดีขึ้นเรื่อย ๆ&nbsp; และอาจหายแพ้ได้เมื่อโตขึ้น&nbsp; หรือแพ้น้อย</p>\r\n\r\n<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>สาเหตุ</strong>ของโรคภูมิแพ้อาหาร&nbsp;เกิดจากการที่ร่างกายตอบสนองต่อสารหรือส่วนประกอบในอาหารแตกต่างไปจากปกติ&nbsp; นอกจากนั้นยังพบว่าหนึ่งในปัจจัยเสี่ยงที่ทำให้เป็นมากขึ้นและพบตั้งแต่เด็ก ๆ คือสาเหตุทางพันธุกรรม&nbsp; เช่น&nbsp; กรณีที่พ่อหรือแม่มีประวัติเป็นภูมิแพ้&nbsp; หรือหากพบลูกคนแรกแพ้อาหาร&nbsp; ลูกคนถัดไปมีแนวโน้มเป็นโรคภูมิแพ้ได้เช่นกัน&nbsp;เพียงแต่ไม่จำเป็นว่าต้องเป็นโรคภูมิแพ้ประเภทเดียวกัน&nbsp; หรืออาหารชนิดเดียวกัน&nbsp; สำหรับปัจจัยอื่น ๆ ที่อาจจะส่งผลให้เกิดการแพ้อาหาร&nbsp; ได้แก่</p>\r\n\r\n<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>พันธุกรรม</strong>&nbsp; เป็นปัจจัยที่หลีกเลี่ยงไม่ได้&nbsp; รวมถึงเพศของเด็ก</p>\r\n\r\n<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>การคลอด&nbsp; </strong>มีงานวิจัยพบว่า&nbsp; <strong>เด็กที่คลอดโดยการผ่ามีความเป็นไปได้ที่จะแพ้อาหารมากกว่าเด็กที่เกิดจากการคลอดธรรมชาติ</strong>เพราะ ขณะที่เด็กคลอดผ่านทางช่องคลอดเด็กจะได้รับจุลินทรีย์ที่มีประโยชน์เข้าไปใน ทางเดินอาหาร โดยได้รับจากแม่หรือสภาพแวดล้อมทำให้เด็กมีภูมิคุ้มกันทางระบบทางเดินอาหาร และลำไส้แข็งแรงกว่า &nbsp; สำหรับเด็กที่ไม่ได้คลอดธรรมชาติแต่คลอดโดยผ่าออกมาทางหน้าท้อง&nbsp; &nbsp;เด็กก็จะไม่ได้รับจุลินทรีย์นี้จากแม่ระหว่างคลอด</p>\r\n\r\n<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>ช่วงให้นมบุตร&nbsp;&nbsp; </strong>ลูกจะได้รับสารอาหารจากน้ำนมแม่&nbsp;&nbsp; หากแม่ไม่ระมัดระวังการกินอาหารหรือกินสิ่งใดมากเกินไป&nbsp; สารนั้นก็อาจไปกระตุ้นให้เด็กก่อภูมิแพ้ได้</p>\r\n\r\n<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>สิ่งแวดล้อม</strong>&nbsp; เด็กไม่จำเป็นต้องแพ้อาหารตั้งแต่เกิด&nbsp; อาจ พบการแพ้อาหารบางชนิดเมื่อเด็กโตขึ้นก็ได้&nbsp;&nbsp; นอกเหนือจากเรื่องของภูมิคุ้มกันของร่างกายของเด็กแล้ว&nbsp;&nbsp; ส่วนหนึ่งอาจเกิดจากสภาวะแวดล้อมที่เติบโต</p>\r\n\r\n<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; นอกจากนี้ยังพบว่า&nbsp; ปัจจุบันเด็กมีภาวะขาดวิตามินดีได้ง่าย&nbsp; อาจเกิดจากวิถีชีวิตที่อยู่แต่ห้องสี่เหลี่ยมตามอาคารชุด&nbsp; ห่างไกลธรรมชาติ&nbsp; ทำให้เด็กสัมผัสแสงแดดน้อยลง&nbsp; มีโอกาสสร้างวิตามินดีลดลง&nbsp; ทำให้เกิดถูมิแพ้ได้ง่ายขึ้นเพราะภูมิต้านทานไม่แข็งแรง</p>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p><strong>ด้วยความปรารถนาดีจาก .... กลุ่มงานสุขศึกษา&nbsp;&nbsp;&nbsp; โรงพยาบาลลำปาง</strong></p>\r\n\r\n<p><strong>E - mail&nbsp; address&nbsp; <a href="mailto:Health.edlph@gmail.com">Health.edlph@gmail.com</a></strong></p>\r\n', '2013-05-22 22:08:44', 1, 1, 0),
(12, 1, 'iphone 6', 'untitled-5.jpg', '<p><strong>อั้ยย่ะ <a href="http://hitech.sanook.com/mobile/" target="_blank">iPhone</a> 6 และ iPhone Mini คอนเซ็ปใหม่ล่าสุด!!</strong></p>\r\n\r\n<p><strong><a href="http://hitech.sanook.com/search/iPhone%206" target="_blank">iPhone 6</a>, iPhone Mini</strong>- มีข่าวลือเกี่ยวกับ <strong>iPhone</strong> รุ่นใหม่อย่าง <strong><a href="http://hitech.sanook.com/tag/iphone%205/" target="_blank">iPhone 5</a>S, <a href="http://hitech.sanook.com/search/iPhone%206" target="_blank">iPhone 6</a>, iPhone Mini (iPhone low cost)</strong> กำลังมีออกมาอย่างต่อเนื่องยิ่งใกล้วันเปิดตัวในเดือนมิถุนายน 2013 &ndash; ใน<strong>งาน WWDC 2013</strong> แอปเปิล ข่าวก็จะพร้อมใจกันหลุดออกมา!!</p>\r\n\r\n<p><img src="http://p.s1sf.com/hi/0/ud/271/1357628/untitled-20.jpg" style="height:675px; width:450px" /></p>\r\n\r\n<p>อย่างล่าสุดที่เว็บไซต์ www.behance.net ได้นำเสนอคอนเซ็ปของ&nbsp;<strong> <a href="http://hitech.sanook.com/search/iPhone%206" target="_blank">iPhone 6</a>, iPhone Mini (iPhone low cost)</strong> ใหม่ล่าสุดออกมาสวยงามไม่เบาครับ เพราะคอนเซ็ปที่เราเห็นล่าสุดนั้นมันถูกออกแบบใหม่ด้วยฝีมือของ JohnnyPlaid นักออกแบบจาก Los Angeles</p>\r\n\r\n<p><img src="http://p.s1sf.com/hi/0/ud/271/1357628/untitled-21.jpg" style="height:675px; width:450px" /></p>\r\n\r\n<p>สำหรับ <strong>iPhone 6, iPhone Mini </strong>ที่เราเห็นในข่าวนั้นจะ ไม่มีขอบของหน้าจอ(โดนใจผมนะแบบนี้) นอกจากนี้การออกแบบสุดอลังการณ์ที่เราได้เห็นแล้ว JohnnyPlaid ยังเพิ่มเติมในส่วนของ สเปค มาให้เราด้วยลอง</p>\r\n\r\n<p><img src="http://p.s1sf.com/hi/0/ud/271/1357628/untitled-5.jpg" style="height:641px; width:427px" /></p>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p>เรียกได้ว่า Apple เป็นแบรนด์ที่ไม่ต้องทุ่มงบประมาณมหาศาลในการโปรโมทสินค้าเหมือนเจ้าอื่นๆ แค่ข่าวหลุด ที่ออกมาให้เราเสพทุกวันก็พอแล้ว!! มาดูกันว่าครับว่าภาพคอนเซ็ปของ iPhone 6 ที่ว่านี้จะสวยงามขนาดไหน</p>\r\n\r\n<p><img src="http://p.s1sf.com/hi/0/ud/271/1357628/untitled-18.jpg" style="height:431px; width:600px" /></p>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p>อ้างอิงจาก: behance.net</p>\r\n\r\n<p>ติดตามข่าวความเคลื่อนไหวของเทคโนโลยีรอบโลกได้ที่นี่ &gt;&gt;&gt;<a href="http://hitech.sanook.com/" target="_blank">&nbsp;</a><a href="http://hitech.sanook.com/" target="_blank">www.hitech.sanook.com</a></p>\r\n', '2013-05-23 23:09:31', 1, 1, 0),
(17, 1, 'ฟฟฟฟฟฟฟฟ', '2013-07-06 13.34.36.jpg', '<p><strong>รายการ &ldquo;ต้นศิลปะ ปี 3&rdquo; อาร์ตเรียลลิตี้สร้างแรงบันดาลใจสู่คนรักศิลปะ ทุกแขนง กับภารกิจสร้างศิลปะเพื่อทุกชีวิต ตอน Art for All</strong></p>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p><strong><img alt="ต้นศิลปะ ปี 3" src="http://p3.s1sf.com/mv/0/ud/7/35030/arttree_3_art_for_all_3.jpg" style="height:400px; width:600px" /></strong></p>\r\n\r\n<p><br />\r\n<br />\r\nรายการ<strong>ต้นศิลปะ</strong> อาร์ตเรียลลิตี้รายการแรกและรายการเดียวของไทยที่ไปคว้ารางวัล Highly Commended ในสาขา Best Reality Show จากเวที <strong>Asian Television Awards 2012</strong> ครั้งที่ 17 และในปีที่ 3 นี้ จะมีเพียงคนเดียวเท่านั้น ที่จะได้เป็นสุดยอดทายาทแห่งต้นศิลปะ ปี 3 และคว้าเงินรางวัลถึง 100,000 บาท</p>\r\n\r\n<p><br />\r\nร่วมเฟ้นหาทายาทโดย 7 ปรมาจารย์ชั้นนำของวงการศิลปะ ได้แก่<br />\r\n&nbsp;</p>\r\n\r\n<p>อาจารย์<strong>เฉลิมชัย โฆษิตพิพัฒน์</strong> สุดยอดปรมาจารย์ พุทธศิลป์ เจ้าของผลงานสุดแสนอลังการ วัดร่องขุ่น และและศิลปินแห่งชาติ สาขาทัศนศิลป์ (จิตรกรรม) ประจำปี 2554<br />\r\nอาจารย์<strong>ทวี รัชนีกร</strong> ปรมาจารย์ผู้เป็นศิลปินรากแก้วแห่งอีสาน และศิลปินแห่งชาติ สาขาทัศนศิลป์ (จิตรกรรม) ประจำปี 2548<br />\r\nอาจารย์<strong>ธงชัย รักปทุม</strong> ปรมาจารย์จิตรกรรมไทยร่วมสมัย &nbsp;และศิลปินแห่งชาติ สาขาทัศนศิลป์ (จิตรกรรม) ประจำปี 2553<br />\r\nอาจารย์<strong>นนทิวรรธน์ จันทนะผะลิน</strong> ปรมาจารย์ทางด้านประติมากรรม &nbsp;และศิลปินแห่งชาติ สาขาทัศนศิลป์ (ประติมากรรม) ประจำปี 2549<br />\r\nผู้ช่วยศาสตราจารย์<strong> ถาวร โกอุดมวิทย์</strong> ศิลปินชั้นเยี่ยม สาขาภาพพิมพ์ ผู้ก่อตั้ง อาร์เดล &nbsp;แกลเลอรี่<br />\r\nอาจารย์<strong>ประทีป คชบัว</strong> สุดยอดปรมาจารย์งานเหนือจริง &nbsp;เซอร์ริลลีสอันดับหนึ่งของประเทศ<br />\r\nอาจารย์<strong>จิตต์สิงห์ สมบุญ</strong> ไอคอนของวงการแฟชั่น หนึ่งใน ดีไซน์เนอร์ชั้นแนวหน้าของเมืองไทย</p>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p><img alt="ต้นศิลปะ ปี 3" src="http://p3.s1sf.com/mv/0/ud/7/35030/arttree_3_art_for_all_1.jpg" style="height:400px; width:600px" /></p>\r\n\r\n<p><br />\r\nเพราะศิลปะถูกสร้างมาเพื่อทุกชีวิต... เมื่อผืนแผ่นดินกลายมาเป็นเฟรม วัสดุเหลือใช้กลับกลายเป็นจินตนาการ คอยพบกับศิลปะการจัดวาง หรือ Installation Art สุดมัน โดยผู้เข้าแข่งขันในรายการ &ldquo;ต้นศิลปะ ปี 3&rdquo; ทั้ง 10 คนสุดท้าย จะต้องนำวัสดุเหลือใช้ในท้องถิ่นไปสร้างสรรค์เป็นผลงานศิลปะลงบนพื้นริม เขื่อนรัฐประชาพัฒนา อ.เมือง จ.ราชบุรี ซึ่งศิลปะประเภทนี้จะต้องคำนึงถึงพื้นที่ สิ่งแวดล้อม และวิถีชีวิตของคนในละแวกนั้นด้วย แถมงานนี้เรายังได้ปรมาจารย์แห่งต้นศิลปะ อาจารย์จิตต์สิงห์ สมบุญ ไอคอนของวงการแฟชั่น หนึ่งในดีไซน์เนอร์ชั้นแนวหน้าของเมืองไทย มาร่วมปลุกแรงบันดาลใจอีกด้วย</p>\r\n\r\n<p><br />\r\nผลงานการจัดวางของพวกเขาจะเต็มไปด้วยไอเดียบรรเจิดซักแค่ไหน &nbsp;และจะกลมกลืนกับสิ่งแวดล้อมและวิถีชีวิตของคนในท้องถิ่นนั้นได้หรือไม่</p>\r\n', '2013-07-06 17:01:38', 1, 1, 0),
(18, 2, 'แฉลีลารัก พระชื่อดัง เสพสมสีกาในรีสอร์ทยั', 'หมวิ.jpg', '<p><a href="http://news.sanook.com" target="_blank"><img alt="S! News" src="http://p3.s1sf.com/ns/0/di/nwpt/sanook-news.jpg" style="height:35px" /> </a> สนับสนุนเนื้อหา</p>\r\n\r\n<p>658</p>\r\n\r\n<p><a href="https://www.facebook.com/sharer/sharer.php?u=http://news.sanook.com/1195700/%E0%B9%81%E0%B8%89%E0%B8%A5%E0%B8%B5%E0%B8%A5%E0%B8%B2%E0%B8%A3%E0%B8%B1%E0%B8%81-%E0%B8%9E%E0%B8%A3%E0%B8%B0%E0%B8%8A%E0%B8%B7%E0%B9%88%E0%B8%AD%E0%B8%94%E0%B8%B1%E0%B8%87-%E0%B9%80%E0%B8%AA%E0%B8%9E%E0%B8%AA%E0%B8%A1%E0%B8%AA%E0%B8%B5%E0%B8%81%E0%B8%B2%E0%B9%83%E0%B8%99%E0%B8%A3%E0%B8%B5%E0%B8%AA%E0%B8%AD%E0%B8%A3%E0%B9%8C%E0%B8%97%E0%B8%A2%E0%B8%B1%E0%B8%99%E0%B8%9B%E0%B9%88%E0%B8%B2%E0%B8%8A%E0%B9%89%E0%B8%B2/" target="_blank"><img alt="Facebook Share Button" src="http://c.s1sf.com/vi/0/di/fb_share_button.png" style="height:20px; width:60px" /></a></p>\r\n\r\n<p>ดีเอสไอลงพื้นที่สอบปากคำ &quot;เมียพระชื่อดัง&quot; ยืนยันคำเดิม มีสัมพันธ์กันตั้งแต่ ม.2 ให้เงินครั้ง 1,000 พาเสพสมที่ รีสอร์ท ยัน ป่าช้า</p>\r\n\r\n<p><img alt="แฉลีลารัก พระชื่อดัง เสพสมสีกาในรีสอร์ทยันป่าช้า" src="http://p3.s1sf.com/ns/0/ud/239/1195700/news02-1.jpg" /></p>\r\n\r\n<p><strong>ดีเอสไอลงพื้นที่สอบปากคำ &quot;เมียพระชื่อดัง&quot; ยืนยันคำเดิม มีสัมพันธ์กันตั้งแต่ ม.2 ให้เงินครั้ง 1,000 พาเสพสมที่ รีสอร์ท ยัน ป่าช้า</strong></p>\r\n\r\n<p>(6 ก.ค.) ความคืบหน้ากรณีอื้อฉาวพระชื่อดัง <strong>พระวิรพล สุขผล</strong> หรือ <strong>พระเณรคำ</strong> ประธานที่พักสงฆ์ป่าขันติธรรม จ.ศรีสะเกษ ล่าสุดทางกรมสอบสวนคดีพิเศษ หรือ ดีเอสไอ ได้ลงพื้นที่ตรวจสอบหาข้อเท็จจริงในหลายจุด รวมทั้งสอบปากคำกรณีสัมพันธ์กับสีกา ทั้งภาพนอนกับผู้หญิง และหญิงสาวที่อ้างว่าเป็นภรรยาของพระและมีลูกชายด้วยกัน</p>\r\n\r\n<p><strong>พันโทนายแพทย์เอนก ยมจินดา</strong> ผู้อำนวยการสถาบันนิติวิทยาศาสตร์ เปิดเผยความคืบหน้ากรณีภาพคล้าย พระเณรคำนอนกับสีกา ระบุว่า ขอใช้เวลาไม่เกิน 7 วัน น่าจะทราบผลว่าเป็นภาพจริงหรือภาพตัดต่อ ปัญหาที่พบน่าจะเป็นในส่วนของคุณภาพของภาพที่มีความละเอียดต่ำ ซึ่งอาจจะไม่ได้รับผลยืนยัน 100% แต่ก็สามา<a href="http://auto.sanook.com/4723/%E0%B8%A3%E0%B8%B2%E0%B8%84%E0%B8%B2%E0%B8%A3%E0%B8%96%E0%B9%83%E0%B8%AB%E0%B8%A1%E0%B9%88/" target="_blank">รถ</a>นำไปใช้ในการดำเนินคดีความได้</p>\r\n\r\n<p>ขณะที่กรณีของ <strong>น.ส.อ้อย (นามสมมติ)</strong> อายุ 27 ปี ซึ่งอ้างว่าเป็นภรรยาของพระเณรคำ และมีลูกชายด้วยกัน 1 คน ปัจจุบันอายุ 11 ปี แล้ว เจ้าหน้าที่ดีเอสไอได้ลงพื้นที่ไปสอบปากคำโดยตรง โดย น.ส.อ้อย ยังคงยืนยันตามคำให้การเดิม ซึ่งระบุว่า เคยมีสัมพันธ์กับพระชื่อดังตั้งแต่สมัยเรียนชั้น ม.2 เนื่องจากเคยไปทำบุญและพระชื่อดังตามจีบ ก่อนจะเริ่มแอบคบหากัน พระชื่อดังจะนัดออกไปเที่ยว โดยขับรถมารับที่หมู่บ้าน พระชื่อดังจะแต่งตัวเสื้อยืด กางเกงยีนส์แบบคนทั่วไป แต่จะสวมใส่หมวกและแว่นตาตลอดเวลา</p>\r\n\r\n<p>น.ส.อ้อย ยังบอกอีกว่า ได้มีเพศสัมพันธ์กับพระชื่อดังครั้งที่บนรถ ก่อนจะมีครั้งต่อๆ ไปอีกหลายครั้งเรื่อยมา ซึ่งพระชื่อดังจะพาไปเสพสมที่รีสอร์ทแห่งหนึ่งที่ จ.อุบลราชธานี หรือไม่ก็ที่กุฏิสงฆ์ในป่าช้าบ้านยาง แต่ละครั้งพระชื่อดังจะให้เงิน 1,000 - 1,500 บาท จนทราบว่าตั้งครรภ์ พระชื่อดังก็ได้เช่าบ้านที่ จ.อุบลราชธานี ให้อยู่ จนคลอดลูกและใช้ชื่อญาติเป็นพ่อของเด็ก</p>\r\n\r\n<p>ทั้งนี้ ภายหลังจากการสอบสวน เจ้าหน้าที่ดีเอสไอได้นำตัว น.ส.อ้อย ไปชี้จุดต่างๆ ที่เกี่ยวข้อง ทั้งรีสอร์ทและป่าช้าบ้านยาง เพื่อเป็นหลักฐานประกอบรูปคดีต่อไป ซึ่ง น.ส.อ้อย ยืนยันว่า เคยมีสัมพันธ์กับพระชื่อดัง โดยมีหลักฐานเป็นเงินส่งเสียเลี้ยงดูลูกชาย แม้ว่าระยะหลังๆ จะขาดส่งและจำนวนลดลงก็ตาม</p>\r\n\r\n<p><em><strong>ขอขอบคุณเนื้อหา<a href="http://news.sanook.com" target="_blank">ข่าว</a>สนับสนุนจาก ไอ.เอ็น.เอ็น และ <a href="http://news.sanook.com/" target="_blank">ข่าวสด</a>ออนไลน์</strong></em></p>\r\n', '2013-07-06 23:01:51', 1, 1, 1);
...
CREATE TABLE IF NOT EXISTS `tb_document` (
  ...
  `id_tb_person` int(11) NOT NULL,
  `doc_38_1` varchar(50) DEFAULT NULL,
  `doc_passport` varchar(50) DEFAULT NULL,
  `doc_visa` varchar(50) DEFAULT NULL,
  `doc_for_permission` varchar(50) DEFAULT NULL,
  `doc_pay_permission` varchar(50) DEFAULT NULL,
  `doc_permission` text,
...
INSERT INTO `tb_document` (`id_document`, `id_tb_person`, `doc_38_1`, `doc_passport`, `doc_visa`, `doc_for_permission`, `doc_pay_permission`, `doc_permission`) VALUES
(89, 0, '', '1002669_10152759130544638_1017426685305322565_n.jp', '', '', '', ''),
(88, 0, '107.jpg', '', '', '', '', ''),
(97, 8, 'IMG_1045.JPG', 'IMG_1046.JPG', 'IMG_1047.JPG', 'IMG_1048.JPG', 'IMG_1044.JPG', 'Work Permit detail'),
(99, 29, 'IMG_1044.JPG', 'IMG_1045.JPG', 'IMG_1046.JPG', 'IMG_1047.JPG', 'IMG_1048.JPG', 'testing Work Permit detail :');
...
CREATE TABLE IF NOT EXISTS `tb_employee` (
  ...
  `tr38_1` varchar(30) NOT NULL,
  `address` text NOT NULL,
  `mobile` varchar(20) NOT NULL,
  `friends_relatives` varchar(30) NOT NULL,
  `mobile_contact` varchar(30) NOT NULL,
  `notice` text NOT NULL,
  `PASSPORT_NO` varchar(30) NOT NULL,
  `iss_passport` date NOT NULL,
  `exp_passport` date NOT NULL,
  `iss_visa` date NOT NULL,
  `exp_visa` date NOT NULL,
  `register_date` date NOT NULL,
  `next_register_date` date NOT NULL,
  `hm_code` varchar(30) NOT NULL,
  `line_section` varchar(50) NOT NULL,
  `start_work_date` date NOT NULL,
  `work_permit` varchar(30) NOT NULL,
  `iss_date_workpermit` date NOT NULL,
  `exp_date_workpermit` date NOT NULL,
  `number_social_security` varchar(20) NOT NULL,
...
INSERT INTO `tb_employee` (`id_employee`, `firstname`, `lastname`, `callname`, `birth_date`, `birth_place`, `tr38_1`, `address`, `mobile`, `friends_relatives`, `mobile_contact`, `notice`, `PASSPORT_NO`, `iss_passport`, `exp_passport`, `iss_visa`, `exp_visa`, `register_date`, `next_register_date`, `hm_code`, `line_section`, `start_work_date`, `work_permit`, `iss_date_workpermit`, `exp_date_workpermit`, `number_social_security`, `date_signup`, `time_record`) VALUES
(29, 'NGALB', 'HTWEAZ', 'gallyman', '1429-01-24', 'MUDOWN  burmar', '056689', 'Bangkok Thailand', '0849537412', 'wasan  komnok', '0867741254', 'Head Man', 'A435999', '2014-09-09', '2014-10-30', '2014-10-01', '2014-10-22', '2014-10-01', '2014-10-23', 'AY1245', 'Sale Management', '2014-11-18', 'ทร.125478', '2014-09-27', '2014-12-17', '0052369852147', '2014-09-27', '2014-09-14 21:12:24'),
(38, 'NAN NGAE LAY', '', '', '1988-10-10', 'YANGON', '0011123568543457', 'Bangkok', '0884567987', 'Htwe', '', '', 'KT112356', '2010-10-07', '2015-10-06', '0000-00-00', '0000-00-00', '0000-00-00', '0000-00-00', '', '', '0000-00-00', '', '0000-00-00', '0000-00-00', '', '0000-00-00', '2014-10-06 21:49:36');
...
CREATE TABLE IF NOT EXISTS `tb_experience` (
  `id_tb_experience` int(11) NOT NULL AUTO_INCREMENT,
  `id_tb_person` int(11) NOT NULL,
  `count_experience` varchar(50) DEFAULT NULL,
  `before_workplace` varchar(50) DEFAULT NULL,
  `workplace` varchar(50) DEFAULT NULL,
  `work_type` varchar(50) DEFAULT NULL,
  `count_year` int(3) DEFAULT NULL,
  PRIMARY KEY (`id_tb_experience`)
...
INSERT INTO `tb_experience` (`id_tb_experience`, `id_tb_person`, `count_experience`, `before_workplace`, `workplace`, `work_type`, `count_year`) VALUES
(6, 5, '4', 'thai oil', 'panasonic', 'laber', 5),
(4, 2, '4', 'thai oil', 'panasonic', 'laber', 5),
(7, 5, '4', 'thai oil', 'panasonic', 'laber', 5),
(10, 3, '4', 'thai oil', 'panasonic', 'laber', 5),
(11, 1, '4', 'thai oil', 'panasonic', 'laber', 5),
(12, 1, '4', 'thai oil', 'panasonic', 'laber', 5),
(13, 1, '4', 'thai oil', 'panasonic', 'laber', 5),
(14, 1, '4', 'thai oil', 'panasonic', 'laber', 5),
(15, 8, '10', 'House', '', '', 0);

-- --------------------------------------------------------

--
-- Table structure for table `tb_head_leftmenu`
--

CREATE TABLE IF NOT EXISTS `tb_head_leftmenu` (
  `id_head_leftmenu` int(11) NOT NULL AUTO_INCREMENT,
  `headmenu` varchar(100) NOT NULL,
  `DMY` datetime NOT NULL,
  `id_user` int(10) NOT NULL,
  `menu_enable` int(1) DEFAULT NULL,
  `delete_status` int(1) DEFAULT NULL,
  PRIMARY KEY (`id_head_leftmenu`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=21 ;

--
-- Dumping data for table `tb_head_leftmenu`
--

INSERT INTO `tb_head_leftmenu` (`id_head_leftmenu`, `headmenu`, `DMY`, `id_user`, `menu_enable`, `delete_status`) VALUES
(1, 'โรคไม่ติดต่อและภัยสุขภาพ', '2013-06-09 09:04:52', 1, 1, 1),
(2, 'เครือข่่ายชุมชน', '2013-06-09 09:04:53', 1, 1, 1),
(3, 'เครือข่ายออทิสติก', '2013-06-09 09:04:56', 1, 1, 1),
(12, 'link3', '2013-06-11 11:08:11', 1, 1, 0),
(18, 'หน่วยงานที่เกี่ยวข้อง / Link', '2013-06-11 11:04:46', 1, 1, 1),
(19, 'link4', '2013-06-11 11:04:47', 1, 1, 0),
(20, 'โรคไม่ติดต่อและภัยสุขภาพ', '2013-06-16 16:06:09', 1, 1, 0);

-- --------------------------------------------------------

--
-- Table structure for table `tb_leave_work`
--

CREATE TABLE IF NOT EXISTS `tb_leave_work` (
  `id_leave_work` int(11) NOT NULL AUTO_INCREMENT,
  `id_tb_person` int(11) NOT NULL,
  `day_work` int(3) DEFAULT NULL,
  `day_summer` int(3) DEFAULT NULL,
  `day_carer` int(3) DEFAULT NULL,
  `day_sick` int(3) DEFAULT NULL,
  `day_absence` int(3) DEFAULT NULL,
  `revenue` float DEFAULT NULL,
  PRIMARY KEY (`id_leave_work`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=4 ;

--
-- Dumping data for table `tb_leave_work`
--

INSERT INTO `tb_leave_work` (`id_leave_work`, `id_tb_person`, `day_work`, `day_summer`, `day_carer`, `day_sick`, `day_absence`, `revenue`) VALUES
(3, 4, 1, 2, 3, 4, 5, 800);
...
CREATE TABLE IF NOT EXISTS `tb_mainmenu` (
  `id_mainmenu` int(10) NOT NULL AUTO_INCREMENT,
  `id_head_leftmenu` int(10) DEFAULT NULL,
  `titlemenu` varchar(100) DEFAULT NULL,
  `DMY` datetime DEFAULT NULL,
  `id_user` int(11) DEFAULT NULL,
  `mainmenu_enable` int(1) DEFAULT NULL,
...
INSERT INTO `tb_mainmenu` (`id_mainmenu`, `id_head_leftmenu`, `titlemenu`, `DMY`, `id_user`, `mainmenu_enable`, `linkmenu`) VALUES
(2, 2, 'จ.ขอนแก่น', '2013-06-16 16:09:36', 1, 1, '#'),
(3, 3, 'ชมรมจิตอาสาพัฒนาเครือข่ายการดูแลบุคลากรออทิสติก', '2013-06-16 16:09:42', 1, 1, '#'),
(4, 18, 'โรงพยาบาลศูนย์ขอนแก่น', '2013-06-16 16:09:43', 1, 1, '#'),
(5, 18, 'สสส.', '2013-06-16 16:09:44', 1, 1, '#'),
(6, 18, 'มูลนิธิสาธารณสุขแห่งชาติ', '2013-06-16 16:09:44', 1, 1, '#'),
(7, 18, 'ศูนย์ควบคุมความปลอดภัยบนท้องถนน', '2013-06-16 16:09:45', 1, 1, '#'),
(8, 18, 'ศจย.', '2013-06-16 16:09:45', 1, 1, '#'),
(9, 18, 'กรมสุขภาพจิต', '2013-06-16 16:09:46', 1, 1, '#'),
(10, 18, 'สอบถามปัญหา', '2013-06-16 16:09:46', 1, 1, '#'),
(14, 1, 'หน่วยงานที่เกี่ยวข้อง', '2013-06-16 16:12:00', 1, 1, '#');
...
CREATE TABLE IF NOT EXISTS `tb_new` (
  `id_tb_new` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(100) NOT NULL,
  `new_picture` varchar(100) DEFAULT NULL,
  `content` text,
  `DMY` datetime DEFAULT NULL,
  `new_enable` int(1) DEFAULT NULL,
  `id_user` int(10) DEFAULT NULL,
  `pin_new` int(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id_tb_new`)
...
INSERT INTO `tb_new` (`id_tb_new`, `title`, `new_picture`, `content`, `DMY`, `new_enable`, `id_user`, `pin_new`) VALUES
(2, 'รู้ไหมว่า .... มะม่วง สาระพัดประโยชน์', 'mango.jpg', '<p>รู้ไหมว่า .... มะม่วง สาระพัดประโยชน์<br />\r\nเมล็ดสด ๆ มารับประทาน หรือนำมาโรยเกลือ รับประทานเพื่อขับปัสสาวะหรือแก้บวมน้ำ เนื้อในเมล็ดใช้แก้ท้องร่วง<br />\r\n<br />\r\nผลมะม่วง นำมาคั้นรับประทานเป็นยาขับปัสสาวะหรือร้อนใน แก้คลื่นไส้ แก้บิดถ่ายเป็นเลือด และใช้เป็นยาบำรุงกระเพาะอาหาร<br />\r\n<br />\r\nใบมะม่วง นำมาพอประมาณต้มรับประทานแก้ซางตานขโมยในเด็ก แก้ลำไส้อักเสบ หรือใช้ใบสดๆ ตำพอกบริเวณที่เป็นแผลสด จะเป็นยาสมานแผลสดได้ดีที่เดียว<br />\r\n<br />\r\nเปลือกลำต้นมะม่วง ใช้เปลือกสดๆ มาต้มรับประทานเป็นยาแก้โรคคอตีบ เยื่อปากอักเสบ จมูกอักเสบ</p>\r\n\r\n<p><a href="https://www.facebook.com/photo.php?fbid=245412345600459&amp;set=a.101175003357528.1334.100003950852257&amp;type=1&amp;relevant_count=1"><img alt="รูปภาพ : รู้ไหมว่า .... มะม่วง สาระพัดประโยชน์\r\nเมล็ดสด ๆ  มารับประทาน หรือนำมาโรยเกลือ รับประทานเพื่อขับปัสสาวะหรือแก้บวมน้ำ เนื้อในเมล็ดใช้แก้ท้องร่วง\r\n\r\nผลมะม่วง นำมาคั้นรับประทานเป็นยาขับปัสสาวะหรือร้อนใน แก้คลื่นไส้ แก้บิดถ่ายเป็นเลือด และใช้เป็นยาบำรุงกระเพาะอาหาร\r\n\r\nใบมะม่วง นำมาพอประมาณต้มรับประทานแก้ซางตานขโมยในเด็ก แก้ลำไส้อักเสบ หรือใช้ใบสดๆ ตำพอกบริเวณที่เป็นแผลสด จะเป็นยาสมานแผลสดได้ดีที่เดียว\r\n\r\nเปลือกลำต้นมะม่วง ใช้เปลือกสดๆ มาต้มรับประทานเป็นยาแก้โรคคอตีบ เยื่อปากอักเสบ จมูกอักเสบ" src="https://fbcdn-sphotos-g-a.akamaihd.net/hphotos-ak-prn2/p480x480/969976_245412345600459_1458406009_n.jpg" style="height:381px; width:504px" /></a></p>\r\n', '2013-05-19 19:04:37', 1, 1, 0),
(3, 'เปลี่ยน LINE ให้เต็มไปด้วยสีชมพู', 'Line.jpg', '<p><strong><a href="http://www.arip.co.th" name="home">[เอ.อาร์.ไอ.พี, www.arip.co.th]</a></strong> เปลี่ยน LINE ให้เต็มไปด้วยสีชมพู ... แอพแชทยอดนิยม LINE ปล่อยอัพเดตอีกครั้ง ซึ่งคราวนี้เอาใจสาวๆ ที่ชอบ หรือกำลังมีความรักด้วยธีมสีชมพู จะเป็นอย่างไรไปติดตามกันเลยจ้าา</p>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p>พื้นที่โฆษณา&nbsp;&nbsp;<img src="http://www.arip.co.th/2006/images/ad/arrow_down.gif" /></p>\r\n\r\n<p>สนใจลงโฆษณา ติดต่อ โทร.0-2642-3400 ต่อ 4613</p>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p><strong>LINE</strong> แอพแชทสุดฮิต เอาใจสาวๆที่ชื่นชอบ และกำลังตกอยู่ในช่วงเวลาแห่งความรักด้วยการปล่อยอัพเดตเวอร์ชัน 3.7.0 บนสมาร์ทโฟนที่เป็น Android ขอย้ำว่า !! เฉพาะ Android เท่านั้น (ในตอนนี้) จุดเด่นหลักคือสามารถเปลี่ยนธีมที่หน้าการใช้งานให้เปลี่ยนเป็น <strong>&quot;สีชมพู&quot; </strong>ได้นอกนั้นก็จะประกอบไปด้วย<br />\r\n<br />\r\n- ธีมที่เปลี่ยนเป็นสีชมพู จะมีตัวการ์ตูนใน LINE บนเมนูต่างๆด้วย<br />\r\n- ใน Official Account มีการเพิ่มโฮมฟังก์ชัน<br />\r\n- ข้อความที่ไม่สามารถส่งได้ จะมีการแจ้งเตือนเข้ามายังผู้ใช้งาน<br />\r\n- รองรับภาษาอิตาเลียน,โปรตุเกส,เยอรมัน<br />\r\n- ทำ QR โค้ดของคุณง่ายต่อการค้นหา<br />\r\n- เพิ่มฟังก์ชั่นภาพใหม่ที่สามารถชมภาพทั้งหมดที่ส่งหรือรับภายในห้องสนทนาของคุณเอง เพียงแตะที่ไอคอน V ที่ด้านบนของแต่ละห้อง</p>\r\n\r\n<p><img alt="" src="http://www.arip.co.th/images/news/2009/%E0%B8%82%E0%B9%88%E0%B8%B2%E0%B8%A7%202013/%E0%B9%81%E0%B8%AD%E0%B8%9E%E0%B8%9E%E0%B8%A5%E0%B8%B4%E0%B9%80%E0%B8%84%E0%B8%8A%E0%B8%B1%E0%B9%88%E0%B8%99%202013/Line%20for%20android%20pink.jpg" style="height:450px; width:263px" /></p>\r\n\r\n<p><img alt="" src="http://www.arip.co.th/images/news/2009/%E0%B8%82%E0%B9%88%E0%B8%B2%E0%B8%A7%202013/%E0%B9%81%E0%B8%AD%E0%B8%9E%E0%B8%9E%E0%B8%A5%E0%B8%B4%E0%B9%80%E0%B8%84%E0%B8%8A%E0%B8%B1%E0%B9%88%E0%B8%99%202013/Line%20for%20android%20pink%202.jpg" style="height:450px; width:263px" /></p>\r\n\r\n<p><img alt="" src="http://www.arip.co.th/images/news/2009/%E0%B8%82%E0%B9%88%E0%B8%B2%E0%B8%A7%202013/%E0%B9%81%E0%B8%AD%E0%B8%9E%E0%B8%9E%E0%B8%A5%E0%B8%B4%E0%B9%80%E0%B8%84%E0%B8%8A%E0%B8%B1%E0%B9%88%E0%B8%99%202013/Line%20for%20android%20pink%203.jpg" style="height:450px; width:254px" /></p>\r\n\r\n<p>ซึ่งผู้ใช้ Android สามารถเข้าไปเลือกธีมดังกล่าวได้ เพียงเข้าไปที่ &gt; Settings &gt; เลือกรายการธีม แล้วกดดาวน์โหลด ก็เป็นอันเสร็จเรียบร้อย ส่วนสาวๆ ใน iOS ก็อย่าเพิ่งเสียใจ เพราะอีกไม่นานก็จะมีอัพเดตออกมาอย่างแน่นอน และในอนาคตก็น่าจะมีธีมอื่นๆมาเอาใจหนุ่มนักแชทด้วยเช่นกันจ้า</p>\r\n', '2013-05-19 19:04:40', 1, 1, 1),
(4, 'อย่าให้คนดีต้องเดินอย่างโดดเดี่ยว', '923082_555658954486136_617739740_n.jpg', '<p><a href="https://www.facebook.com/photo.php?fbid=555658954486136&amp;set=a.139105096141526.33528.100001261100165&amp;type=1&amp;theater#">ติดตาม</a> &middot; 16 พฤษภาคม</p>\r\n\r\n<p><br />\r\nอย่าให้คนดีต้องเดินอย่างโดดเดี่ยวครับ<br />\r\nพวกเราตืนมาช่วยกัน!<br />\r\nไม่เช่นนั้นจะลามถึงทุกคนอย่างเลี่ยงไม่ได้ &mdash; กับ <a href="https://www.facebook.com/cvoranuch">Chatchanok Voranuch</a>, <a href="https://www.facebook.com/somboonc">Somboon Chaisitthiporn</a>, <a href="https://www.facebook.com/pabhavee.bulakul">Pabhavee Bulakul</a> และ<a href="https://www.facebook.com/photo.php?fbid=555658954486136&amp;set=a.139105096141526.33528.100001261100165&amp;type=1&amp;theater#">อีก 45 คน</a></p>\r\n\r\n<p><a href="https://www.facebook.com/photo.php?fbid=555658954486136&amp;set=a.139105096141526.33528.100001261100165&amp;type=1&amp;theater#">ถูกใจ</a> &middot; <a href="https://www.facebook.com/ajax/sharer/?s=2&amp;appid=2305272732&amp;p%5B0%5D=100001261100165&amp;p%5B1%5D=94241287&amp;sharer_type=all_modes">แชร์</a></p>\r\n\r\n<ul>\r\n	<li>&nbsp;</li>\r\n	<li>\r\n	<p><a href="https://www.facebook.com/browse/likes?id=555658954486136">4,111 คน</a> ถูกใจสิ่งนี้</p>\r\n	</li>\r\n	<li>\r\n	<p><a href="https://www.facebook.com/shares/view?id=555658954486136">10,832 shares</a></p>\r\n	</li>\r\n	<li>\r\n	<p><a href="https://www.facebook.com/photo.php?fbid=555658954486136&amp;set=a.139105096141526.33528.100001261100165&amp;type=1&amp;theater#">ดูอีก 33 ความคิดเห็น</a></p>\r\n	</li>\r\n	<li>\r\n	<p><a href="https://www.facebook.com/sbanyong"><img alt="" src="https://fbcdn-profile-a.akamaihd.net/hprofile-ak-prn1/s32x32/572688_100001261100165_1679541091_q.jpg" /></a></p>\r\n\r\n	<p><a href="https://www.facebook.com/sbanyong">คนทำสื่อ ชื่อลุงยงค์</a> ขอบคุณทุกกลังใจที่ให้หมอนะครับ จะทำจดหมายส่งไปให้ท่านครับ</p>\r\n\r\n	<p><a href="https://www.facebook.com/photo.php?fbid=555658954486136&amp;set=a.139105096141526.33528.100001261100165&amp;type=1&amp;comment_id=1834102&amp;offset=0&amp;total_comments=39">วัน วันเสาร์ เวลา 9:20 น.</a> &middot; <a href="https://www.facebook.com/photo.php?fbid=555658954486136&amp;set=a.139105096141526.33528.100001261100165&amp;type=1&amp;theater#">ถูกใจ</a> &middot; <a href="https://www.facebook.com/browse/likes?id=556373014414730">12</a></p>\r\n	</li>\r\n</ul>\r\n', '2013-05-20 20:02:56', 1, 1, 0),
(5, 'ยุงลายเหตุรำคาญ พบแหล่งเพาะพันธุ์ต้องกำจัด', '4_47.jpg', '<h1>ยุงลายเหตุรำคาญ พบแหล่งเพาะพันธุ์ต้องกำจัด</h1>\r\n\r\n<p>โดย pimchanok | วันที่ 20 พฤษภาคม 2556</p>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p><img alt="" src="http://www.thaihealth.or.th/sites/default/files/users/user-15259/4_47.jpg" style="height:145px; width:285px" /></p>\r\n\r\n<p><strong>กรมอนามัย กระทรวงสาธารณสุข เผยประกาศกระทรวงสาธารณสุขเรื่องกำหนดให้แหล่งเพาะพันธุ์ยุงลายเป็นเหตุ รำคาญในพระราชบัญญัติการสาธารณสุขพ.ศ.2535 พร้อมแนวทางการปฏิบัติของเจ้าพนักงานท้องถิ่นเจ้าพนักงานสาธารณสุข และผู้ครอบครองอาคารหากไม่มีการควบคุมและป้องกันแหล่งเพาะพันธุ์ลูกน้ำยุง ลายให้ดำเนินการตามบทลงโทษตามกฎหมายได้ทันที</strong></p>\r\n\r\n<p><strong>นายแพทย์ณรงค์ สายวงศ์ รองอธิบดีกรมอนามัยเปิดเผยถึงแนวทางการควบคุมแหล่งเพาะพันธุ์ยุงลายตามประกาศกระทรวงสาธารณสุข</strong>ว่า จากสถานการณ์การระบาดของโรคไข้เลือดออกที่รุนแรงในขณะนี้เป็นปัญหาสาธารณสุข ที่ต้องป้องกันเฝ้าระวังอย่างเข้มแข็งพร้อมเร่งกำจัดแหล่งเพาะพันธุ์ยุงลาย ในภาชนะหรือเศษวัสดุที่มีน้ำขังและเมื่อมีการตรวจพบลูกน้ำหรือตัวโม่งยุงลาย ถือเป็นเหตุรำคาญ</p>\r\n\r\n<p>ซึ่งราชการส่วนท้องถิ่น เจ้าพนักงานท้องถิ่นและเจ้าพนักงานสาธารณสุขสามารถดำเนินการควบคุมได้ทันที ตั้งแต่ 1. ประชาสัมพันธ์ให้ประชาชนในท้องถิ่นทราบถึงอันตรายของโรคไข้เลือดออกลักษณะ อาการ การควบคุมและป้องกันแหล่งเพาะพันธุ์ยุงลายรวมทั้งผลทางกฎหมายที่กำหนดให้ แหล่งเพาะพันธุ์ยุงลายเป็นเหตุรำคาญ 2. ให้เจ้าพนักงานท้องถิ่นเจ้าพนักงานสาธารณสุขเฝ้าระวังโรคและควบคุมแหล่งเพาะ พันธุ์ยุงลายในเขตท้องที่ที่รับผิดชอบ 3. หากพบว่าอาคารหรือสถานที่ของเอกชนมีแหล่งเพาะพันธุ์ยุงลายให้แจ้งหรือแนะนำ ให้เจ้าของหรือผู้ครอบครองอาคารหรือสถานที่นั้นปรับปรุงแก้ไขและ 4. หากเจ้าของหรือผู้ครอบครองอาคารไม่ให้ความร่วมมือหรือไม่ปรับปรุงแก้ไขตามคำ แนะนำให้เจ้าพนักงานท้องถิ่นออกคำสั่งตามมาตรา28 ให้ปรับปรุงแก้ไขภายในระยะเวลาที่กำหนดหากฝ่าฝืนไม่ปฏิบัติตามจะมีบทลงโทษ โดยปรับไม่เกิน 2,000 บาทหรือจำคุกไม่เกินหนึ่งเดือน หรือทั้งจำทั้งปรับได้ตามมาตรา 74</p>\r\n\r\n<p>นายแพทย์ณรงค์ กล่าวต่อไปว่ากรณีที่ตรวจพบแหล่งเพาะพันธุ์ยุงลายในที่หรือทางสาธารณะเจ้า พนักงานท้องถิ่นสามารถดำเนินการได้ทันทีหากทราบว่าแหล่งเพาะพันธุ์ยุงลาย นั้นเกิดจากการกระทำของบุคคลใดให้ออกคำสั่งตามมาตรา27 ให้บุคคลนั้นปรับปรุงแก้ไขตามระยะเวลาที่กำหนดถ้าไม่ปฏิบัติตามให้ท้องถิ่น สั่งการให้ดำเนินการลงโทษตามบทบัญญัติมาตรา74 ข้างต้นได้เช่นกันแต่หากไม่ปรากฏว่าเกิดจากบุคคลใดให้เจ้าพนักงานท้องถิ่น สั่งการให้เจ้าหน้าที่สาธารณสุขของท้องถิ่นดำเนินการทำลายแหล่งเพาะพันธุ์ นั้นได้โดยการถมระบายน้ำ ทิ้ง คว่ำ หรือใส่สารเคมีกำจัดลูกน้ำ แล้วแต่กรณีที่เหมาะสม</p>\r\n\r\n<p>ส่วนกรณีที่เป็นอาคารรกร้างว่างเปล่าหรือก่อสร้างไม่เสร็จโดยไม่ปราก ฎเจ้าของชัดเจนและเป็นแหล่งเพาะพันธุ์ยุงลายให้ราชการส่วนท้องถิ่นดำเนินการ ทำลายแหล่งพันธุ์ยุงลายนั้นได้เพราะหากมีการเฝ้าระวังที่ดีจะป้องกันไข้ เลือดออกไม่ให้แพร่ระบาดได้โดยอาจไม่ต้องใช้มาตรการกฎหมาย&quot;วิธีการตรวจและ เฝ้าระวังแหล่งเพาะพันธุ์ยุงลายนั้นสามารถดำเนินการได้โดยประชาชนอาจให้ความ ร่วมมือในการตรวจดูภาชนะหรือเศษวัสดุที่มีน้ำขังทั้งในหรือนอกอาคารว่ามีลูก น้ำหรือตัวโม่งยุงลายหรือไม่ซึ่งจากสถิติทั่วไปพบว่าลูกน้ำในภาชนะหรือเศษ วัสดุที่มีน้ำขังจะเป็นลูกน้ำยุงลายร้อยละ 95 ขึ้นไปหากพบว่ามีลูกน้ำหรือตัวโม่งให้ประชาชนเทน้ำทิ้งและเปลี่ยนน้ำในภาชนะ ทุกๆ 7 วันก็จะเป็นการป้องกันมิให้เกิดแหล่งเพาะพันธุ์ยุงลายในครัวเรือนและชุมชน ได้</p>\r\n\r\n<p>นอกจากนี้ การดำเนินการเมื่อเปิดภาคเรียนควรมีการคัดกรองหรือวัดไข้เด็กหากพบว่าเด็ก นักเรียนมีไข้ร่วมกับไอหรือเจ็บคอให้สวมหน้ากากอนามัยแต่หากมีเพียงอาการไข้ อย่างเดียว ให้สงสัยอาจเป็นไข้เลือดออกควรแนะนำให้ทายากันยุงเพื่อลดการแพร่เชื้อจากผู้ ป่วยไปสูยุงและยุงกัดเด็กคนอื่นและให้นักเรียนแกนนำสุขภาพแจ้งการป่วยของ เพื่อนนักเรียน ควรปลูกตะไคร้หอมเพื่อใช้สำหรับกันยุงในห้องเรียน</p>\r\n\r\n<p>และขอความร่วมมือให้นักเรียนแกนนำสุขภาพรณรงค์ควบคุมลูกน้ำยุงลายเป็น ประจำสัปดาห์ละ 1 ครั้ง โดยเฉพาะสัปดาห์ที่มีฝนตก ควรกำจัดขยะและภาชนะเหลือใช้ที่จะกลายเป็นแหล่งเพาะพันธุ์ยุงลายภายใน 7 วัน ที่สำคัญการนอนกลางวันของเด็กในศูนย์เด็กเล็กควรตรวจดูมุ้งลวดของอาคารศูนย์ เด็กเล็กไม่ให้ชำรุดหากไม่ได้อยู่ในห้องที่มีมุ้งลวด ควรให้เด็กนอนในมุ้งและแนะนำผู้ปกครองให้ดูแลเด็กที่นอนกลางวันในบ้าน โดยให้นอนกางมุ้งเพื่อป้องกันยุงกัด&quot; รองอธิบดีกรมอนามัย กล่าวในที่สุด</p>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p><strong>ที่มา : </strong>กรมอนามัย</p>\r\n', '2013-05-20 20:02:58', 1, 1, 0),
(6, 'ไส้กรอก" ตวงขายตามน้ำหนัก เสี่ยงไม่ปลอดภัย', 'printed 3d baby.jpeg', '<h1>&quot;ไส้กรอก&quot; ตวงขายตามน้ำหนัก เสี่ยงไม่ปลอดภัย</h1>\r\n\r\n<p>โดย pimchanok | วันที่ 20 พฤษภาคม 2556</p>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p><img alt="" src="http://www.thaihealth.or.th/sites/default/files/users/user-15259/1_68.jpg" style="height:145px; width:285px" /></p>\r\n\r\n<p><strong>นายอินทาวุธ สรรพวรสถิตย์ อาจารย์ประจำภาควิชาเทคโนโลยีทางอาหาร คณะวิทยาศาสตร์ จุฬาลงกรณ์มหาวิทยาลัย กล่าวว่า ปัจจุบันอาหารประเภทไส้กรอกได้รับความนิยมสูง เพราะรับประทานง่าย และราคาไม่แพงนัก อย่างไรก็ตาม มักจะมีคำถามมากมายในเรื่องการรับประทานไส้กรอกว่า มีส่วนผสมอะไรบ้าง รับประทานแล้วปลอดภัยต่อสุขภาพหรือไม่ และควรเลือกรับประทานไส้กรอกชนิดใดจึงจะปลอดภัย</strong></p>\r\n\r\n<p>ซึ่งจากการศึกษาและรวบรวมข้อมูลผลิตภัณฑ์ไส้กรอกในประเทศไทยพบว่า จุดแรกของการเลือกซื้อไส้กรอกมารับประทาน จะต้องดูจากบรรจุภัณฑ์ว่าได้รับมาตรฐานความปลอดภัยจากสำนักงานคณะกรรมการ อาหารและยา (อย.) หรือไม่ ที่สำคัญต้องระมัดระวังไส้กรอกที่วางขายอยู่ตามท้องตลาด โดยเฉพาะไส้กรอกที่ตวงขายตามน้ำหนัก เพราะไม่มีฉลากบอกรายละเอียดของผลิตภัณฑ์ ดังนั้น ควรเลือกซื้อไส้กรอกที่บรรจุถุง หรือในบรรจุภัณฑ์ที่มีฉลากบอกรายละเอียดของผลิตภัณฑ์และการรับรองจาก อย.</p>\r\n\r\n<p>นายอินทาวุธกล่าวอีกว่า สำหรับส่วนประกอบของไส้กรอกที่มีข้อกังวลว่า จะส่งผลต่อสุขภาพหรือไม่ อย่างสารไนเตรทและไนไตรท์ ซึ่งจะทำให้ไส้กรอกมีสีชมพู มีกลิ่นและรสชาติเฉพาะ รวมทั้งยังช่วยป้องกันการเติบโตของจุลินทรีย์ ที่จะสร้างสารโบทูลินัม ทอกซิน หรือที่เรียกกันว่าโบท็อกซ์ ถ้าผู้บริโภครับประทานในปริมาณที่มากเกินไป จะทำให้อวัยวะภายในเกิดอัมพาตชั่วคราวได้</p>\r\n\r\n<p>ดังนั้น การเลือกซื้อไส้กรอกผู้บริโภคควรสังเกตจากสีของไส้กรอก โดยเลือกสีที่ใกล้เคียงธรรมชาติที่สุด ขณะที่บรรจุภัณฑ์ต้องปิดมิดชิด มีเครื่องหมาย อย. วันหมดอายุอย่างชัดเจน อย่างไรก็ตาม กระทรวงสาธารณสุขมีกฎหมายควบคุมการเติมสารกลุ่มไนเตรทและไนไตรท์ในปริมาณ เล็กน้อย เพียงพอที่จะป้องกันการเจริญเติบโตของเชื้อจุลินทรีย์ดังกล่าว หากเลือกซื้อไส้กรอกที่ได้มาตรฐานก็จะสร้างความมั่นใจได้ว่า ปลอดภัยในการบริโภค</p>\r\n\r\n<p>ผู้สื่อข่าวถามว่า เด็กคนที่อยู่ระหว่างลดน้ำหนัก และผู้ป่วยควรบริโภคไส้กรอกหรือไม่ นายอินทาวุธกล่าวว่า ไส้กรอกคือ อาหารโปรตีนชนิดหนึ่ง มีส่วนประกอบ คือ เกลือ ไขมัน ซึ่งเด็กรับประทานได้ แต่หลักการรับประทานอาหารต้องไม่ทานอาหารชนิดเดียวกันซ้ำกันนานเกินไป ส่วนผู้ที่อยู่ระหว่างการลดน้ำหนัก ต้องพิจารณาจากปริมาณพลังงานจากอาหาร แต่ละอย่างที่รับประทานแต่ละวัน เช่น หากรับประทานไส้กรอกแล้ว ยังรับประทานข้าว หรือแป้งชนิดอื่นๆ เข้าไปอีก ก็อาจน้ำหนักขึ้นได้ ส่วนผู้ป่วยขึ้นอยู่กับป่วยเป็นโรคอะไร และแพทย์ให้จำกัดอาหารชนิดใดเป็นต้น</p>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p><strong>ที่มา :</strong> หนังสือพิมพ์มติชน</p>\r\n', '2013-05-20 20:03:14', 1, 1, 0),
(7, 'ปล่อยคาราวานรถปลอดภัยประจำจุดเสี่ยง 28 แห่งระวังเด', '14.jpg', '<h1>ปล่อยคาราวานรถปลอดภัยประจำจุดเสี่ยง 28 แห่งระวังเด็กตีกัน</h1>\r\n\r\n<p>โดย gidanan ganghair | วันที่ 17 พฤษภาคม 2556</p>\r\n\r\n<p><strong><img alt="" src="http://www.thaihealth.or.th/sites/default/files/users/user-16058/556000006129903.jpeg" style="height:145px; width:285px" /></strong></p>\r\n\r\n<p><strong>ศธ.จับมือเครือข่ายเฝ้าระวังเหตุ เด็กทะเลาะวิวาท พร้อมปล่อยคาราวานรถปลอดภัยดูแล 28 จุดเสี่ยง รอบกรุงเทพและปริมณฑล ย้ำต้องไม่ปล่อยให้การวิวาทเป็นเรื่องธรรมดาของสังคมไทย</strong></p>\r\n\r\n<p><strong>นายพงศ์เทพ เทพกาญจนา รัฐมนตรีว่าการกระทรวงศึกษาธิการ </strong>เป็น ประธานในพิธีปล่อยขบวนรถยนต์ปฎิบัติการศูนย์เสมารักษ์ ในโครงการ &ldquo;ไปเรียนปลอดภัย&rdquo; ของสำนักการลูกเสือ ยุวกาชาดและกิจการนักเรียน พร้อมกล่าวว่า จากข้อมูลและสถิติของสำนักงานลูกเสือและหน่วยงานที่เกี่ยวข้องกับการแก้ ปัญหาก่อเหตุทะเลาะวิวาทของนักเรียนพบว่า จะมีการก่อเหตุบ่อยครั้งในช่วงเปิดภาคเรียนและช่วงเวลาก่อนและหลังเลิกเรียน เป็นอันตรายต่อการเดินทางไปกลับโรงเรียนของนักเรียน นักศึกษาทั่วไป เพราะฉะนั้น ศธ.จะได้จัดโครงการดังกล่าวขึ้นเพื่อประสานความร่วมมือระหว่างหน่วยงานต่างๆ ทั้ง กระทรวงศึกษาธิการ สถานีตำรวจนครบาล องค์การขนส่งมวลชนกรุงเทพ (ขสมก.) และศูนยเสมารักษ์ เพื่อเฝ่าระวังจุดเสี่ยง 28 จุด ใน 5 โซนครอบคลุม กทม.และปริมณฑล รวมถึงจะมีการจัดหน่วยเครือข่ายเคลื่อนที่เร็ว เพื่อเข้าระงับเหตุเมื่อมีการก่อเหตุทะเลาะวิวาทด้วย</p>\r\n\r\n<p>&ldquo; เรื่องความปลอดภัยเด็กเป็นเรื่องที่ผู้ปกครองให้ความสำคัญ เพราะไม่มีใครอยากเห็นบุตรหลานของตนเองบาดเจ็บหรือเกิดอุบัติเหตุ ที่ผ่านมามีเหตุการณ์เกิดขึ้นจากความขัดแย้งของนักศึกษา ซึ่งถึงแม้เป็นกลุ่มน้อยแต่ทำให้เกิดผลกระทบไปถึงผู้บริสุทธิ์จำนวนมาก จึงไม่อยากเห็นเหตุการณ์แบบนี้เกิดขึ้นอีก เพราะทำให้สถาบันเสียชื่อเสียงไปด้วย ดังนั้นทุกฝ่ายจะต้องมาร่วมมือกันป้องกันและเฝ้าระวังเพื่อไม่ให้เหตุการณ์ ทะเลาะวิวาทของเด็กกลายเป็นเรื่องปกติของสังคมไทย&rdquo; นายพงศ์เทพ กล่าว</p>\r\n\r\n<p><strong>ด้านนายศุภกรณ์ วงศ์ปราชญ์ รองปลัด ศธ.</strong>กล่าวว่า จากข้อมูลสถิติของสำนักลูกเสือฯและหน่วยงานที่เกี่ยวข้องพบว่า ปัญหาการทะเลาะวิวาทของนักเรียนนักศึกษาส่วนใหญ่จะเป็นระดับอาชีวศึกษา และช่วงเวลาก่อเหตุจะอยู่ในช่วงเปิดภาคเรียนที่ 1 ของปีการศึกษา ก่อนเข้าโรงเรียนและเวลาหลังเลิกเรียนไปจนถึงเวลา 20.30 น.โดยเฉพาะจุดเสี่ยงที่เกิดเหตุ ได้แก่ ป้ายรถประจำทาง ห้างสรรพสินค้า และบริเวณหน้าสถานศึกษา จึงมีการดำเนินโครงการจัดทำแผนปฎิบัติงานแบ่งพื้นที่ออกเป็น5 โซน พร้อมกำหนดจุดเสี่ยงสำคัญเพื่อเฝ้าระวังตั้งแต่วันที่ 16 พ.ค.-20 มิ.ย.ในเขตพื้นที่กรุงเทพมหานครและปริมณฑล</p>\r\n\r\n<p>&nbsp;สำหรับจุดเสี่ยงในเขตกรุงเทพมหานครและปริมณฑล 28 แห่ง ได้แก่ 1.หน้าห้างสรรพสินค้าพาต้าปิ่นเกล้า 2.แยกสวนมิกสักวัน 3.สี่แยกปทุมวัน 4.ป้ายรถประจำทางวิทยาลัยเทคโนโลยีสยาม 5.ป้ายรถประจำทางหน้าโรงเรียนบางปะกอกวิทยาคม 6.ตลอดบางแค 7.ป้ายรถประจำทางหน้าวิทยาลัยวิบูลบริหารธุรกิจสี่แยกท่าพระ 8.ตลาดอ้อมน้อยสี่แยกพุทธมนฑลสาย5 9.วงแหวนเอกชัย-บางบอน 10.สามแยกราษฎร์บูรณะ มหาวิทยาลัยราชมงคลธนบุรี 11.ตลาดมีนบุรี 12.ตลาดหนอกจอก 13.ศูนย์การค้าแฟชั่นไอส์แลนด์ ถนนรามอินทรา 14.ซอยมิสทีน ถนนสุขาภิบาล 3 15.ศูนย์การค้าเดอะมอลล์บางกะปิ 16.ป้ายรถประจำทางหน้าวัดดอนเมือง 17.สถานีรถไฟดอนเมือง 18.ป้ายรถประจำทางหน้าเซ็นทรัลรามอินทรา 19.อู่รถประจำทาง หน้าวัดพระศรีมหาธาตุ 20.ตลาดสะพานใหม่ดอนเมือง 21.หน้าโรงเรียนไทยวิจิตรศิลป์ 22.สี่แยกเกษตรศาสตร์ 23.หน้าเซ็นทรัลลาดพร้าว 24.แยกบางนา 25.ห้างสรรพสินค้าเซ็นทรัลบางนา 26.หน้าโรงเรียนปทุมคงคา 27.ห้างสรรพสินค้าอิมพีเรียลสำโรง และ 28.ตลาดปากน้ำ</p>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p><strong>ที่มา :</strong> หนังสือพิมพ์ ASTV ผู้จัดการ</p>\r\n', '2013-05-20 20:03:16', 1, 1, 0),
(8, 'iPhone 5S จะเพิ่มความละเอียดหน้าจอ', 'iphone5s.jpg', '<p><strong><a href="http://www.arip.co.th" name="home">[เอ.อาร์.ไอ.พี, www.arip.co.th]</a></strong> iPhone 5S จะเพิ่มความละเอียดของจอแสดงผล ... เป็นข่าวรายวันจริงๆสำหรับอุปกรณ์รุ่นใหม่ของ Apple อย่าง iPhone 5S ที่มีการคาดหมายกันไว้ว่ามันจะเป็นฮาร์ดแวร์รุ่นใหม่ในตระกูล iPhone ตัวแรกที่เปิดตัวในปีนี้ พร้อมกับหลายสิ่งหลายอย่างที่เพิ่มขึ้นมาใน iPhone 5S</p>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p>พื้นที่โฆษณา&nbsp;&nbsp;<img src="http://www.arip.co.th/2006/images/ad/arrow_down.gif" /></p>\r\n\r\n<p>สนใจลงโฆษณา ติดต่อ โทร.0-2642-3400 ต่อ 4613</p>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p><img alt="" src="http://www.arip.co.th/images/news/2009/%E0%B8%82%E0%B9%88%E0%B8%B2%E0%B8%A7%202013/Apple%202013/new%20retina%20display%20iphone%205s.jpg" style="height:313px; width:500px" /></p>\r\n\r\n<p>เว็บไซต์ WeiPhone ของจีนได้รายงานว่า Apple กำลังมีความพยายามในการเพิ่มความละเอียดของหน้าจอแสดงผลใน<strong> iPhone 5S</strong> ให้มากกว่าจอ<strong> Retina Display </strong>บน <strong>iPhone 5</strong> ซึ่งจะมีการเพิ่มจำนวนพิกเซลจากเดิม 730,000 เป็น 1.5 ล้านพิกเซล ทำให้มีความหนาแน่นของพิกเซลบนหน้าจอขนาด 4 นิ้วนั้นมากขึ้น แหล่งข่าวยังระบุว่าการเพิ่มความละเอียดบนหน้าจอ iPhone 5S ทาง Apple อาจใช้เทคนิคเดียวกับที่ใช้ใน iPad mini ด้วยการขยายขอบจอแสดงผลให้ติดกับขอบตัวเครื่องมากขึ้น หากเป็นไปอย่างที่เว็บไซต์จีนอ้างไว้ก็อาจทำให้นักพัฒนาแอพพลิเคชั่นบน iOS ต้องรับภาระในการปรับความละเอียดของการแสดงผลให้เข้ากับจอแสดงผลใหม่ของ iPhone 5S<br />\r\n<br />\r\nจากข้อมูลดังกล่าวทำให้คิดได้ว่าการมาของสมาร์ทโฟนรุ่น ใหม่ๆ ที่ปรับความละเอียดของการแสดงผลมาที่ 1080p ส่งผลต่อ Apple พอสมควร การมีจอแสดงผลระดับ Retina Display ที่ให้ความคมชัดชนิดที่สายตาแทบแยกไม่ออกแล้วเป็นตัวชูโรงอาจไม่พอสำหรับ Apple อีกต่อไป ดังนั้นความเปลี่ยนแปลงที่จะมากับ iPhone 5S จึงเป็นสิ่งที่ Apple ต้องการทิ้งห่างคู่แข่งรายอื่นๆออกไป</p>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p><br />\r\n<strong>Tags:</strong> <a href="http://www.arip.co.th/tag/iphone+5s" target="_blank">iphone 5s</a> <a href="http://www.arip.co.th/tag/retina+display" target="_blank">retina display</a> <a href="http://www.arip.co.th/tag/apple" target="_blank">apple</a> <a href="http://www.arip.co.th/tag/iphone" target="_blank">iphone</a> <a href="http://www.arip.co.th/tag/%E0%B8%82%E0%B9%88%E0%B8%B2%E0%B8%A7%E0%B9%84%E0%B8%AD%E0%B8%97%E0%B8%B5" target="_blank">ข่าวไอที</a> <a href="http://www.arip.co.th/tag/arip" target="_blank">arip</a></p>\r\n', '2013-05-20 20:03:18', 1, 1, 0);
INSERT INTO `tb_new` (`id_tb_new`, `title`, `new_picture`, `content`, `DMY`, `new_enable`, `id_user`, `pin_new`) VALUES
(9, 'เตือนระวังไข้ปวดข้อ “ชิคุนกุนยา” ระบาดพร้อมไข้เลือ', 'medmed01001.gif', '<h1>เตือนระวังไข้ปวดข้อ &ldquo;ชิคุนกุนยา&rdquo; ระบาดพร้อมไข้เลือดออก</h1>\r\n\r\n<p>โดย gidanan ganghair | วันที่ 17 พฤษภาคม 2556</p>\r\n\r\n<p><strong><img alt="" src="http://www.thaihealth.or.th/sites/default/files/users/user-16058/medmed01001.gif" style="height:145px; width:285px" /></strong></p>\r\n\r\n<p><strong>สธ.เตือนประชาชนระวังโรคไข้ปวดข้อ ยุงลายหรือ โรคชิคุนกุนยาจะกลับมาระบาดพร้อมโรคไข้เลือดออก หลังผลวิจัยพบว่าในหลายพื้นที่โดยเฉพาะ สตูล ชุมพร ตรัง สุราษฏร์ธานี ชลบุรี ฉะเชิงเทรา ยุงลายสวนติดเชื้อชิคุนกุนยาสูงถึงร้อยละ 39 ยุงบางตัวมีทั้งเชื้อไวรัสเดงกีและเชื้อไวรัสชิคุนกุนยาอยู่ในตัวเดียว และพบว่าไม่จำเป็นว่ายุงต้องไปกัดผู้ป่วยแล้วจึงจะมีเชื้อ วิธีป้องกันโรคได้ดีที่สุดคือการกำจัดแหล่งเพาะพันธุ์ยุงลายและการป้องกัน ไม่ให้ยุงกัด ทั้งกลางวันและกลางคืน</strong></p>\r\n\r\n<p><strong>นพ.นิพนธ์ โพธิ์พัฒนชัย อธิบดีกรมวิทยาศาสตร์การแพทย์</strong> เปิดเผยผลการวิจัย ของกรมวิทยาศาสตร์การแพทย์ กระทรวงสาธารณสุข ร่วมกับ คณะแพทยศาสตร์ จุฬาลงกรณ์มหาวิทยาลัย พบว่าในหลายพื้นที่โดยเฉพาะจังหวัดสตูล ชุมพร ตรัง สุราษฏร์ธานี ชลบุรี ฉะเชิงเทรา ยุงลายสวนติดเชื้อไวรัสชิคุนกุนยา (Chikungunya virus) สูงถึงร้อยละ 39 ยุงบางตัวติดเชื้อไวรัสทั้งสองชนิด ได้แก่ เชื้อไวรัสเดงกี (Dengue virus) ซึ่งทำให้เกิดไข้เลือดออก และเชื้อไวรัสชิคุนกุนยา หรือไข้ปวดข้อยุงลาย นอกจากนี้ความรู้ จากการวิจัยยังพบว่าไม่จำเป็นว่ายุงต้องไปกัดผู้ป่วยแล้วจึงจะมีเชื้อ และเชื้อไวรัสทั้งสองชนิดนี้ยังสามารถถ่ายทอดจากแม่ยุงไปยังลูกยุงได้ด้วย</p>\r\n\r\n<p>วิธีการป้องกันโรคได้ดีที่สุดคือการกำจัดแหล่งเพาะพันธุ์ยุงลาย ซึ่งส่วนใหญ่จะอยู่ในบริเวณบ้าน เช่น โอ่งเก็บน้ำฝนไม่มีฝาปิด อ่างเก็บน้ำในห้องน้ำ จานรองขาตู้กับข้าว แจกันบูชาพระ กระป๋อง ถ้วยน้ำหรือ แก้วพลาสติกที่ทิ้งไม่เป็นที่เป็นทางและมีน้ำขัง เศษขยะ กล่องโฟม รวมถึงยางรถยนต์เก่า เป็นต้น ด้วยวิธี การง่ายๆ เช่น คว่ำหรือปิดฝาภาชนะดังกล่าวให้สนิท ตรวจรอบๆ บ้านว่ามีแหล่งน้ำขังหรือไม่ หากมีต้องกำจัดการเก็บกวาดสิ่งปฏิกูลออกไป และอีกทางหนึ่งคือการป้องกันไม่ให้ยุงกัดทั้งกลางวันและกลางคืน ซึ่งแต่เดิมเข้าใจว่ายุงลายกัดเฉพาะเวลากลางวัน แต่ผลการวิจัยพบว่าปัจจุบันในบ้านเรายุงลายกัดไม่เลือกเวลา ปรับตัวตามพฤติกรรม ของคน และพบว่าอุณหภูมิบนยอดดอย ที่สูงขึ้นทำให้ยุงลายกัดบ่อยขึ้นและขยายพันธุ์ได้บนภูเขาสูง ต่างจากความรู้เดิมที่ว่ายุงลายบ้านไม่สามารถขยายพันธุ์ได้บนที่สูงเกิน 350 เมตร ดังนั้นอาจจะทำให้เกิดการระบาดของไข้ปวดข้อยุงลายและไข้เลือดออกในหมู่ชาว ดอย เพราะไม่เคยมีภูมิคุ้มกันมาก่อน</p>\r\n\r\n<p>นพ.นิพนธ์ กล่าวต่อว่า การป้องกันการกัดของยุง นอกจากใส่เสื้อผ้ามิดชิดแล้ว ต้องชโลม ยาทากันยุงให้ทั่วส่วนที่โผล่พ้นเสื้อผ้า เพราะกลไกการป้องกันยุงของสารทาป้องกันยุงที่สำคัญ คือ ปกป้องบริเวณที่ทาไม่ให้ยุงหาเป้าหมายเจอ ส่วนบริเวณผิวหนังใกล้เคียงซึ่งไม่ได้ทายาจะไม่ถูกปกป้อง ซึ่งสารออกฤทธิ์ที่ป้องกันยุงกัดได้ดีที่สุดและมีอายุการใช้งานยาวนานในการ เก็บมากที่สุดจนถึงขณะนี้คือ สารดีทหรือ ไดเอททิล โทลูเอไมด์ ที่มีความเข้มข้นร้อยละ 15-30 โดยน้ำหนัก ซึ่งจะป้องกันการกัดของยุงทั้งกลางวันและกลางคืนได้ 4-7 ชั่วโมงขึ้นอยู่กับตำรับ บุคคล และสิ่งแวดล้อมบริเวณที่ใช้ องค์การอนามัยโลกจึงแนะนำให้ใช้ป้องกันโรค ที่ระบาดโดยแมลง รองลงมาจากดีท คือ สารออกฤทธิ์ที่เหมาะสำหรับใช้กับเด็กเล็กต่ำกว่าสี่ขวบ ซึ่งเป็นสารสังเคราะห์เลียนแบบกรดอะมิโนจากธรรมชาติ คือ ไออาร์ 3535 หรือเอททิลบิวทิลอะซิติลอะมิโนโปรปิโอเนท โดยองค์กรพิทักษ์สิ่งแวดล้อมแห่งประเทศสหรัฐอเมริกา (United States Environmental Protection Agency) หรือยูเอสอีพีเอ อนุญาตให้ใช้ในเด็กได้ตั้งแต่อายุหกเดือน แต่ในประเทศไทย โดยสำนักงานคณะกรรมการอาหารและยา (อย.) ให้ใช้ได้ตั้งแต่สองขวบขึ้นไป</p>\r\n\r\n<p>สำหรับน้ำมันหอมระเหยจากสมุนไพรต้องทาซ้ำทุกครึ่งชั่วโมง สำหรับป้องกันการกัดของยุงลายหรือ ยุงน้ำกร่อย และทาซ้ำทุก 2-3 ชั่วโมง สำหรับการป้องกันการกัดของยุงกลางคืน ทั้งนี้ขึ้นอยู่กับตำรับ ที่แต่ละแหล่งผลิต และในการใช้ผลิตภัณฑ์ทาป้องกันยุงหากรู้สึกร้อนผิวให้ล้างออกด้วยสบู่และน้ำ สะอาด และเปลี่ยนไปใช้ผลิตภัณฑ์แผ่นไล่ยุงชนิดแมท ซึ่งใช้คู่กับอุปกรณ์เสียบไฟฟ้า เนื่องจากบางคนผิวจะไวต่อการแพ้ แต่ควรใช้ในที่ซึ่งอากาศถ่ายเทได้ ซึ่งจะปกป้องการกัดได้ประมาณร้อยละ 80-90</p>\r\n\r\n<p><strong>นพ.สมชาย แสงกิจพร ผู้อำนวยการสถาบันวิจัยวิทยาศาสตร์สาธารณสุขกรมวิทยาศาสตร์การแพทย์ </strong>กล่าว เพิ่มเติมว่า การเฝ้าระวังระดับพันธุกรรมของเชื้อไวรัสชิคุนกุนยา พบว่าขณะนี้มีทั้งสายพันธุ์แอฟริกาที่กลายพันธุ์และสายพันธุ์เอเชียดั้งเดิม คนไทยบางคนและนักท่องเที่ยว ส่วนใหญ่ที่ยังไม่มีภูมิคุ้มกันต่อเชื้อไวรัสชิคุนกุนยา จึงเสี่ยงต่อการป่วยด้วยโรคนี้ แม้ว่าจะไม่ทำให้ตายเหมือนไข้เลือดออก แต่ความทรมานจากการปวดข้อรุนแรงและไม่หายขาด บางรายปวดข้อเป็นปีก็ยังไม่หายและ แม่ที่กำลังตั้งครรภ์ที่ได้รับเชื้อสามารถถ่ายทอดไปสู่ทารกได้ ทำให้ทารกเกิดใหม่มีไข้ มีผื่น ไม่ค่อยขยับตัว และหายใจเร็ว ต้องการการดูแลเป็นพิเศษ จึงไม่ควรซื้อยามารับประทานเอง แต่ให้ไปที่สถานบริการสาธารณสุข จะได้เข้าสู่ระบบการเฝ้าระวังโรคและให้การรักษาที่ถูกต้อง</p>\r\n\r\n<p>เนื่องจากอาการของโรคไข้ปวดข้อยุงลายหรือโรคชิคุนกุนยามีลักษณะคล้ายกับ โรคไข้เลือดออก การตรวจรักษาของแพทย์จำเป็นต้องอาศัยผลการตรวจชันสูตรทางห้องปฏิบัติการ เพื่อเป็นเครื่องมือยืนยันว่าผู้ป่วยเป็นโรคอะไร กรมวิทยาศาสตร์การแพทย์ ได้พัฒนาศักยภาพระบบการตรวจวิเคราะห์เชื้อไวรัส ชิคุนกุนยาและเชื้อไวรัสเดงกีทางห้องปฏิบัติการ รวมทั้งดำเนินการเฝ้าระวังโรคทางห้องปฏิบัติการ ทั้งในส่วนกลางและส่วนภูมิภาค ให้สามารถรายงานผล ได้อย่างรวดเร็วและมีความถูกต้อง แม่นยำ โดยเฉพาะ ในรายเร่งด่วนสามารถตรวจวิเคราะห์และรายงานผลได้ภายใน 24 ชั่วโมง ซึ่งเป็นผลดีต่อแนวทางการรักษาผู้ป่วยและการควบคุมโรคได้อย่างมีประสิทธิภาพ มากยิ่งขึ้น ดังนั้น โรงพยาบาลของรัฐหรือเอกชนทั่วประเทศ สามารถส่งตัวอย่างของผู้ป่วยมาตรวจวิเคราะห์ได้ที่ สถาบันวิจัยวิทยาศาสตร์สาธารณสุข กรมวิทยาศาสตร์การแพทย์หรือในส่วนภูมิภาคส่งตรวจได้ที่ศูนย์วิทยาศาสตร์การ แพทย์ 14 แห่งทั่วประเทศ ได้แก่ เชียงใหม่ เชียงราย พิษณุโลกนครสวรรค์ สมุทรสงคราม ชลบุรี ขอนแก่น อุดรธานี นครราชสิมา อุบลราชธานี สุราษฏร์ธานี ภูเก็ต สงขลา และตรัง</p>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p><strong>ที่มา : </strong>หนังสือพิมพ์ ASTVผู้จัดการ</p>\r\n', '2013-05-20 20:03:18', 1, 1, 0),
(10, 'สูบบุหรี่เพิ่มความเสี่ยงวัณโรค', 'printed 3d baby.jpeg', '<p>สูบบุหรี่เพิ่มความเสี่ยงวัณโรค</p>\r\n\r\n<p>การ สูบบุหรี่เป็นอันตรายต่อชีวิต&nbsp; เป็นพิษต่อผู้ใกล้ชิดและสิ่งแวดล้อม&nbsp; &nbsp;บุหรี่เป็นอันตรายต่อสุขภาพ ทำให้เกิดโรคทุกระบบ&nbsp;&nbsp; โดยเฉพาะโรคระบบทางเดินหายใจ &nbsp;ปอด&nbsp; มะเร็งกล่องเสียง&nbsp; มะเร็งปอด มะเร็งกระเพาะปัสสาวะ และมะเร็งอีกหลายระบบ&nbsp;&nbsp; บุหรี่ทำให้ผู้เป็นโรคเบาหวาน&nbsp; ความดันโลหิตสูงเกิดโรคแทรกซ้อนคือกล้ามเนื้อหัวใจขาดเลือด&nbsp; โรคอัมพฤกษ์&nbsp; อัมพาตได้&nbsp;&nbsp; นอกจากนี้การสูบบุหรี่เพิ่มความเสี่ยงต่อการเกิดโรควัณโรคด้วย</p>\r\n\r\n<p>ผู้ ที่สูบบุหรี่จะติดเชื้อวัณโรคง่ายกว่าคนที่ไม่สูบบุหรี่&nbsp; เพราะ การสูบบุหรี่ทำให้เม็ดเลือดขาวตายเพิ่มมากขึ้น&nbsp; ร่างกายมีภูมิต้านทานลดลง&nbsp;&nbsp; สารพิษจากควันบุหรี่จะทำลายเนื้อปอด &nbsp;ทำให้การขจัดเชื้อโรคของเยื่อบุหลอดลมและปอดอ่อนแอลง &nbsp;เมื่อผู้สูบบุหรี่ได้รับเชื้อวัณโรคที่ปะปนอยู่ในอากาศเข้าสู่ปอด&nbsp; เชื้อจึงสามารถเจริญเติบโตและเพิ่มปริมาณจนทำให้เป็นโรคได้&nbsp;&nbsp; ผู้สูบบุหรี่จึงติดเชื้อวัณโรคได้ง่ายกว่าผู้ไม่สูบ</p>\r\n\r\n<p>มี ข้อมูลยืนยันว่าผู้ที่สูบบุหรี่และผู้ที่เคยสูบบุหรี่แล้วเลิก มีอัตราการติดเชื้อวัณโรคสูงกว่าผู้ที่ไม่เคยสูบบุหรี่เลย &nbsp;&nbsp;โดยความเสี่ยงการเกิดวัณโรค ขึ้นอยู่กับเวลาที่สูบบุหรี่&nbsp; ยิ่งสูบนานความเสี่ยงก็ยิ่งสูง และยังพบว่า ผู้ที่เป็นวัณโรคแล้วยังไม่เลิกสูบบุหรี่&nbsp; อัตราการเสียชีวิตจากวัณโรคจะเพิ่มขึ้นหลายเท่า&nbsp; จากรายงานพบว่า ร้อยละ 61 ของผู้ป่วยที่เสียชีวิตจากวัณโรค &nbsp;เป็นผู้ป่วยวัณโรคที่สูบบุหรี่ &nbsp;และเด็กที่อยู่ในบ้านซึ่งมีผู้สูบบุหรี่ป่วยเป็นวัณโรคในระยะแพร่เชื้อ&nbsp; จะติดเชื้อและเป็นวัณโรคได้ง่ายกว่าเด็กทั่วไป</p>\r\n\r\n<p><strong>ประโยชน์ที่จะได้รับจากการเลิกสูบบุหรี่ในผู้ป่ววัณโรค&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong>&nbsp;&nbsp;</p>\r\n\r\n<p>* การตอบสนองต่อการรักษาจะดีขึ้น&nbsp; โรคหายเร็วขึ้น</p>\r\n\r\n<p>* อาการไอลดลงเร็วขึ้น&nbsp; การแพร่เชื้อสู่คนในบ้านหรือคนใกล้ชิดจะลดลง</p>\r\n\r\n<p>* เนื้อปอดจะถูกทำลายจากเชื้อวัณโรคน้อยลง&nbsp; ทำให้โรคหายและดำเนินชีวิตตามปกติ</p>\r\n\r\n<p><strong>หาก คุณเป็นคนหนึ่งที่อยากเลิกสูบบุหรี่&nbsp; ขอเป็นกำลังใจ ให้คุณเลิกได้สำเร็จ &nbsp;&nbsp;จึงขอเสนอ&nbsp; ก. ข. ค. ง. จ. เพื่อการเลิกสูบบุหรี่ &nbsp;ดังนี้</strong></p>\r\n\r\n<p><strong>ก.&nbsp;</strong><strong>กำจัดอุปกรณ์</strong>ที่เกี่ยวข้องกับการสูบบุหรี่ให้หมด</p>\r\n\r\n<p><strong>ข.&nbsp;</strong><strong>เข้มแข็ง</strong>เข้าไว้ หากมีอาการหงุดหงิดหรือเครียด บอกตัวเองให้สู้ สู้ และสู้</p>\r\n\r\n<p><strong>ค.&nbsp;</strong><strong>คุมน้ำหนัก</strong>ด้วยการเลือกอาหารจำพวกผัก&nbsp; ผลไม้ให้มากกว่าเดิม</p>\r\n\r\n<p><strong>ง.&nbsp;</strong><strong>งดเครื่องดื่มแอลกอฮอล์</strong>และกิจกรรมที่มักทำร่วมกับการสูบบุหรี่</p>\r\n\r\n<p><strong>จ.&nbsp;</strong><strong>จดจำไว้</strong>เสมอว่า&nbsp; การเลิกสูบบุหรี่ทำให้สุขภาพของท่านดีขึ้น ทำให้ปอดแข็งแรง&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>\r\n\r\n<p><strong>&nbsp;</strong></p>\r\n\r\n<p><strong>&nbsp;</strong></p>\r\n\r\n<p><strong>ด้วยความปรารถนาดีจาก</strong><strong> .&hellip; กลุ่มงานสุขศึกษา &nbsp;&nbsp;&nbsp;โรงพยาบาลลำปาง</strong></p>\r\n\r\n<p><strong>E mail address <a href="mailto:Health.edlph@gmail.com">Health.edlph@gmail.com</a></strong></p>\r\n', '2013-05-22 22:08:42', 1, 1, 0),
(11, 'ภูมิแพ้อาหาร', 'htc.jpg', '<p><strong>ภูมิแพ้อาหาร</strong></p>\r\n\r\n<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>การแพ้อาหาร</strong> ถือเป็นโรคภูมิแพ้ประเภทหนึ่งที่พบมาก&nbsp; นอกเหนือจากโรคภูมิแพ้ผิวหนัง&nbsp; แพ้อากาศ&nbsp; หรือหอบหืด&nbsp; มีรายงานจากสหรัฐอเมริกา&nbsp; พบว่า &nbsp;ประชากรมากกว่า ๑๒ ล้านคนเป็นโรคภูมิแพ้อาหารและเกิดขึ้นในเด็กประมาณ ๓ ล้านคน&nbsp;&nbsp; จึงเห็นได้ว่าโรคนี้เกิดขึ้นมานานหลายสิบปี&nbsp; และมีแนวโน้มเพิ่มขึ้นเรื่อย ๆ ทั้งเด็กและผู้ใหญ่&nbsp;&nbsp; เนื่องจากการการใช้ชีวิตและสิ่งแวดล้อมรอบ ๆ ตัวที่เปลี่ยนแปลงไป&nbsp;&nbsp;&nbsp; สำหรับประเทศไทยมีแนวโน้มเด็กเป็นภูมิแพ้อาหารเพิ่มมากขึ้นจากอาหารบางชนิด&nbsp; ได้แก่&nbsp; นมวัว&nbsp; ไข่&nbsp; และแป้งสาลี&nbsp; โดยเฉพาะขวบปีแรกอาจมีระดับการแพ้สูงขึ้นช่วงระยะหนึ่ง&nbsp; แต่หลังจาก ๒ - ๓ ขวบจะดีขึ้นเรื่อย ๆ&nbsp; และอาจหายแพ้ได้เมื่อโตขึ้น&nbsp; หรือแพ้น้อย</p>\r\n\r\n<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>สาเหตุ</strong>ของโรคภูมิแพ้อาหาร&nbsp;เกิดจากการที่ร่างกายตอบสนองต่อสารหรือส่วนประกอบในอาหารแตกต่างไปจากปกติ&nbsp; นอกจากนั้นยังพบว่าหนึ่งในปัจจัยเสี่ยงที่ทำให้เป็นมากขึ้นและพบตั้งแต่เด็ก ๆ คือสาเหตุทางพันธุกรรม&nbsp; เช่น&nbsp; กรณีที่พ่อหรือแม่มีประวัติเป็นภูมิแพ้&nbsp; หรือหากพบลูกคนแรกแพ้อาหาร&nbsp; ลูกคนถัดไปมีแนวโน้มเป็นโรคภูมิแพ้ได้เช่นกัน&nbsp;เพียงแต่ไม่จำเป็นว่าต้องเป็นโรคภูมิแพ้ประเภทเดียวกัน&nbsp; หรืออาหารชนิดเดียวกัน&nbsp; สำหรับปัจจัยอื่น ๆ ที่อาจจะส่งผลให้เกิดการแพ้อาหาร&nbsp; ได้แก่</p>\r\n\r\n<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>พันธุกรรม</strong>&nbsp; เป็นปัจจัยที่หลีกเลี่ยงไม่ได้&nbsp; รวมถึงเพศของเด็ก</p>\r\n\r\n<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>การคลอด&nbsp; </strong>มีงานวิจัยพบว่า&nbsp; <strong>เด็กที่คลอดโดยการผ่ามีความเป็นไปได้ที่จะแพ้อาหารมากกว่าเด็กที่เกิดจากการคลอดธรรมชาติ</strong>เพราะ ขณะที่เด็กคลอดผ่านทางช่องคลอดเด็กจะได้รับจุลินทรีย์ที่มีประโยชน์เข้าไปใน ทางเดินอาหาร โดยได้รับจากแม่หรือสภาพแวดล้อมทำให้เด็กมีภูมิคุ้มกันทางระบบทางเดินอาหาร และลำไส้แข็งแรงกว่า &nbsp; สำหรับเด็กที่ไม่ได้คลอดธรรมชาติแต่คลอดโดยผ่าออกมาทางหน้าท้อง&nbsp; &nbsp;เด็กก็จะไม่ได้รับจุลินทรีย์นี้จากแม่ระหว่างคลอด</p>\r\n\r\n<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>ช่วงให้นมบุตร&nbsp;&nbsp; </strong>ลูกจะได้รับสารอาหารจากน้ำนมแม่&nbsp;&nbsp; หากแม่ไม่ระมัดระวังการกินอาหารหรือกินสิ่งใดมากเกินไป&nbsp; สารนั้นก็อาจไปกระตุ้นให้เด็กก่อภูมิแพ้ได้</p>\r\n\r\n<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>สิ่งแวดล้อม</strong>&nbsp; เด็กไม่จำเป็นต้องแพ้อาหารตั้งแต่เกิด&nbsp; อาจ พบการแพ้อาหารบางชนิดเมื่อเด็กโตขึ้นก็ได้&nbsp;&nbsp; นอกเหนือจากเรื่องของภูมิคุ้มกันของร่างกายของเด็กแล้ว&nbsp;&nbsp; ส่วนหนึ่งอาจเกิดจากสภาวะแวดล้อมที่เติบโต</p>\r\n\r\n<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; นอกจากนี้ยังพบว่า&nbsp; ปัจจุบันเด็กมีภาวะขาดวิตามินดีได้ง่าย&nbsp; อาจเกิดจากวิถีชีวิตที่อยู่แต่ห้องสี่เหลี่ยมตามอาคารชุด&nbsp; ห่างไกลธรรมชาติ&nbsp; ทำให้เด็กสัมผัสแสงแดดน้อยลง&nbsp; มีโอกาสสร้างวิตามินดีลดลง&nbsp; ทำให้เกิดถูมิแพ้ได้ง่ายขึ้นเพราะภูมิต้านทานไม่แข็งแรง</p>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p><strong>ด้วยความปรารถนาดีจาก .... กลุ่มงานสุขศึกษา&nbsp;&nbsp;&nbsp; โรงพยาบาลลำปาง</strong></p>\r\n\r\n<p><strong>E - mail&nbsp; address&nbsp; <a href="mailto:Health.edlph@gmail.com">Health.edlph@gmail.com</a></strong></p>\r\n', '2013-05-22 22:08:44', 1, 1, 0),
(12, 'iphone 6', 'untitled-5.jpg', '<p><strong>อั้ยย่ะ <a href="http://hitech.sanook.com/mobile/" target="_blank">iPhone</a> 6 และ iPhone Mini คอนเซ็ปใหม่ล่าสุด!!</strong></p>\r\n\r\n<p><strong><a href="http://hitech.sanook.com/search/iPhone%206" target="_blank">iPhone 6</a>, iPhone Mini</strong>- มีข่าวลือเกี่ยวกับ <strong>iPhone</strong> รุ่นใหม่อย่าง <strong><a href="http://hitech.sanook.com/tag/iphone%205/" target="_blank">iPhone 5</a>S, <a href="http://hitech.sanook.com/search/iPhone%206" target="_blank">iPhone 6</a>, iPhone Mini (iPhone low cost)</strong> กำลังมีออกมาอย่างต่อเนื่องยิ่งใกล้วันเปิดตัวในเดือนมิถุนายน 2013 &ndash; ใน<strong>งาน WWDC 2013</strong> แอปเปิล ข่าวก็จะพร้อมใจกันหลุดออกมา!!</p>\r\n\r\n<p><img src="http://p.s1sf.com/hi/0/ud/271/1357628/untitled-20.jpg" style="height:675px; width:450px" /></p>\r\n\r\n<p>อย่างล่าสุดที่เว็บไซต์ www.behance.net ได้นำเสนอคอนเซ็ปของ&nbsp;<strong> <a href="http://hitech.sanook.com/search/iPhone%206" target="_blank">iPhone 6</a>, iPhone Mini (iPhone low cost)</strong> ใหม่ล่าสุดออกมาสวยงามไม่เบาครับ เพราะคอนเซ็ปที่เราเห็นล่าสุดนั้นมันถูกออกแบบใหม่ด้วยฝีมือของ JohnnyPlaid นักออกแบบจาก Los Angeles</p>\r\n\r\n<p><img src="http://p.s1sf.com/hi/0/ud/271/1357628/untitled-21.jpg" style="height:675px; width:450px" /></p>\r\n\r\n<p>สำหรับ <strong>iPhone 6, iPhone Mini </strong>ที่เราเห็นในข่าวนั้นจะ ไม่มีขอบของหน้าจอ(โดนใจผมนะแบบนี้) นอกจากนี้การออกแบบสุดอลังการณ์ที่เราได้เห็นแล้ว JohnnyPlaid ยังเพิ่มเติมในส่วนของ สเปค มาให้เราด้วยลอง</p>\r\n\r\n<p><img src="http://p.s1sf.com/hi/0/ud/271/1357628/untitled-5.jpg" style="height:641px; width:427px" /></p>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p>เรียกได้ว่า Apple เป็นแบรนด์ที่ไม่ต้องทุ่มงบประมาณมหาศาลในการโปรโมทสินค้าเหมือนเจ้าอื่นๆ แค่ข่าวหลุด ที่ออกมาให้เราเสพทุกวันก็พอแล้ว!! มาดูกันว่าครับว่าภาพคอนเซ็ปของ iPhone 6 ที่ว่านี้จะสวยงามขนาดไหน</p>\r\n\r\n<p><img src="http://p.s1sf.com/hi/0/ud/271/1357628/untitled-18.jpg" style="height:431px; width:600px" /></p>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p>อ้างอิงจาก: behance.net</p>\r\n\r\n<p>ติดตามข่าวความเคลื่อนไหวของเทคโนโลยีรอบโลกได้ที่นี่ &gt;&gt;&gt;<a href="http://hitech.sanook.com/" target="_blank">&nbsp;</a><a href="http://hitech.sanook.com/" target="_blank">www.hitech.sanook.com</a></p>\r\n', '2013-05-23 23:09:31', 1, 1, 0);
...
CREATE TABLE IF NOT EXISTS `tb_passport` (
  ...
  `id_tb_person` int(11) NOT NULL,
  `date_passport_expire_begin` date DEFAULT NULL,
  `count_date_passport` int(3) DEFAULT NULL,
  `place_passport` varchar(50) DEFAULT NULL,
  `date_passport_expire` date DEFAULT NULL,
...
INSERT INTO `tb_passport` (`id_passport`, `id_tb_person`, `date_passport_expire_begin`, `count_date_passport`, `place_passport`, `date_passport_expire`, `date_passport`, `date_report`) VALUES
(6, 3, '2014-02-10', 17, 'สมุทรปราการ', '2014-02-27', '2014-02-24', '2014-02-24'),
(5, 3, '2014-02-10', 17, 'สมุทรปราการ', '2014-02-27', '2014-02-24', '2014-02-24'),
(4, 4, '2014-02-24', 30, 'สมุทรปราการ', '2014-02-11', '2014-02-13', '2014-02-13'),
(7, 5, '2014-02-10', 3, 'สมุทรปราการ', '2014-02-13', '2014-02-18', '2014-02-18'),
(8, 1, '2014-04-29', 708, 'สมุทรปราการ', '2016-04-06', '2014-04-24', '2014-04-24');
...
CREATE TABLE IF NOT EXISTS `tb_permission` (
  ...
  `authoriz_sjj` varchar(50) DEFAULT NULL,
  `authoriz_sjk` varchar(50) DEFAULT NULL,
...
INSERT INTO `tb_permission` (`id_permission`, `id_tb_person`, `date_permission`, `authoriz_sjj`, `authoriz_sjk`, `date_shot`, `remark`, `study`, `academy`, `aptitude`) VALUES
(5, 5, '2014-02-03', 'สมุทรปราการ', 'อำเภอเมือง', '2014-02-06', 'จำเป็นต้องเปลี่ยนที่อยู่ใหม่', 'Bachelor''s Degree', 'km university', 'พูดได้หลายภาษา'),
(4, 4, NULL, 'สมุทรปราการ', 'อำเภอเมือง', NULL, 'จำเป็นต้องเปลี่ยนที่อยู่ใหม่', 'Bachelor''s Degree', 'km university', 'พูดได้หลายภาษา'),
(6, 7, NULL, '', '', NULL, '', '', '', '');
...
CREATE TABLE IF NOT EXISTS `tb_person` (
  `id_tb_person` int(11) NOT NULL AUTO_INCREMENT,
  `prename` int(1) NOT NULL,
  `name` varchar(30) NOT NULL,
  `lastname` varchar(35) NOT NULL,
  `nickname` varchar(20) DEFAULT NULL,
  `id_peson` varchar(15) DEFAULT NULL,
  `id_passport` varchar(15) DEFAULT NULL,
  `id_code_person` varchar(15) DEFAULT NULL,
  `person_enable` int(1) NOT NULL,
  PRIMARY KEY (`id_tb_person`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=10 ;
...
INSERT INTO `tb_person` (`id_tb_person`, `prename`, `name`, `lastname`, `nickname`, `id_peson`, `id_passport`, `id_code_person`, `person_enable`) VALUES
(1, 2, 'sombat', 'metanee', 'big', '0123456789012', 'A111111', 'E7001', 1),
(2, 2, 'sombat', 'metanee', 'big', '0123456789012', 'A111111', 'E7001', 1),
(3, 1, 'sombat', 'metanee', 'big', '0123456789012', 'A111111', 'E7001', 1),
(4, 2, 'sombat', 'metanee', 'big', '0123456789012', 'A111111', 'E7001  ', 1),
(5, 1, 'aa', 'bb', 'cc', '333333333333333', 'QQ333333', 'ZZ002  ', 1),
(6, 1, 'testing', 'client2', 'big', '0123456789012', 'A111111', 'E7001  ', 1),
(7, 1, 'THAN SOE', '', 'DA', '0012345678901', 'KT028321', 'HMP001', 1),
(8, 2, 'NAN TIN POPO', '', 'POPO', '', 'KT106636', 'HMP002', 1),
(9, 2, 'PATT', '', 'PATT', '', 'KT001001', 'HMP0023', 1);
...
CREATE TABLE IF NOT EXISTS `tb_pr` (
  `id_tb_pr` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(100) NOT NULL,
  `pr_picture` varchar(100) DEFAULT NULL,
  `content` text,
  `DMY` datetime DEFAULT NULL,
  `pr_enable` int(1) DEFAULT NULL,
  `id_user` int(10) DEFAULT NULL,
  `pin_pr` int(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id_tb_pr`)
...
INSERT INTO `tb_pr` (`id_tb_pr`, `title`, `pr_picture`, `content`, `DMY`, `pr_enable`, `id_user`, `pin_pr`) VALUES
(3, 'เปลี่ยน LINE ให้เต็มไปด้วยสีชมพู', 'Line.jpg', '<p><strong><a href="http://www.arip.co.th" name="home">[เอ.อาร์.ไอ.พี, www.arip.co.th]</a></strong> เปลี่ยน LINE ให้เต็มไปด้วยสีชมพู ... แอพแชทยอดนิยม LINE ปล่อยอัพเดตอีกครั้ง ซึ่งคราวนี้เอาใจสาวๆ ที่ชอบ หรือกำลังมีความรักด้วยธีมสีชมพู จะเป็นอย่างไรไปติดตามกันเลยจ้าา</p>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p>พื้นที่โฆษณา&nbsp;&nbsp;<img src="http://www.arip.co.th/2006/images/ad/arrow_down.gif" /></p>\r\n\r\n<p>สนใจลงโฆษณา ติดต่อ โทร.0-2642-3400 ต่อ 4613</p>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p><strong>LINE</strong> แอพแชทสุดฮิต เอาใจสาวๆที่ชื่นชอบ และกำลังตกอยู่ในช่วงเวลาแห่งความรักด้วยการปล่อยอัพเดตเวอร์ชัน 3.7.0 บนสมาร์ทโฟนที่เป็น Android ขอย้ำว่า !! เฉพาะ Android เท่านั้น (ในตอนนี้) จุดเด่นหลักคือสามารถเปลี่ยนธีมที่หน้าการใช้งานให้เปลี่ยนเป็น <strong>&quot;สีชมพู&quot; </strong>ได้นอกนั้นก็จะประกอบไปด้วย<br />\r\n<br />\r\n- ธีมที่เปลี่ยนเป็นสีชมพู จะมีตัวการ์ตูนใน LINE บนเมนูต่างๆด้วย<br />\r\n- ใน Official Account มีการเพิ่มโฮมฟังก์ชัน<br />\r\n- ข้อความที่ไม่สามารถส่งได้ จะมีการแจ้งเตือนเข้ามายังผู้ใช้งาน<br />\r\n- รองรับภาษาอิตาเลียน,โปรตุเกส,เยอรมัน<br />\r\n- ทำ QR โค้ดของคุณง่ายต่อการค้นหา<br />\r\n- เพิ่มฟังก์ชั่นภาพใหม่ที่สามารถชมภาพทั้งหมดที่ส่งหรือรับภายในห้องสนทนาของคุณเอง เพียงแตะที่ไอคอน V ที่ด้านบนของแต่ละห้อง</p>\r\n\r\n<p><img alt="" src="http://www.arip.co.th/images/news/2009/%E0%B8%82%E0%B9%88%E0%B8%B2%E0%B8%A7%202013/%E0%B9%81%E0%B8%AD%E0%B8%9E%E0%B8%9E%E0%B8%A5%E0%B8%B4%E0%B9%80%E0%B8%84%E0%B8%8A%E0%B8%B1%E0%B9%88%E0%B8%99%202013/Line%20for%20android%20pink.jpg" style="height:450px; width:263px" /></p>\r\n\r\n<p><img alt="" src="http://www.arip.co.th/images/news/2009/%E0%B8%82%E0%B9%88%E0%B8%B2%E0%B8%A7%202013/%E0%B9%81%E0%B8%AD%E0%B8%9E%E0%B8%9E%E0%B8%A5%E0%B8%B4%E0%B9%80%E0%B8%84%E0%B8%8A%E0%B8%B1%E0%B9%88%E0%B8%99%202013/Line%20for%20android%20pink%202.jpg" style="height:450px; width:263px" /></p>\r\n\r\n<p><img alt="" src="http://www.arip.co.th/images/news/2009/%E0%B8%82%E0%B9%88%E0%B8%B2%E0%B8%A7%202013/%E0%B9%81%E0%B8%AD%E0%B8%9E%E0%B8%9E%E0%B8%A5%E0%B8%B4%E0%B9%80%E0%B8%84%E0%B8%8A%E0%B8%B1%E0%B9%88%E0%B8%99%202013/Line%20for%20android%20pink%203.jpg" style="height:450px; width:254px" /></p>\r\n\r\n<p>ซึ่งผู้ใช้ Android สามารถเข้าไปเลือกธีมดังกล่าวได้ เพียงเข้าไปที่ &gt; Settings &gt; เลือกรายการธีม แล้วกดดาวน์โหลด ก็เป็นอันเสร็จเรียบร้อย ส่วนสาวๆ ใน iOS ก็อย่าเพิ่งเสียใจ เพราะอีกไม่นานก็จะมีอัพเดตออกมาอย่างแน่นอน และในอนาคตก็น่าจะมีธีมอื่นๆมาเอาใจหนุ่มนักแชทด้วยเช่นกันจ้า</p>\r\n', '2013-05-19 19:04:40', 1, 1, 1),
(8, 'iPhone 5S จะเพิ่มความละเอียดหน้าจอ', 'iphone5s.jpg', '<p><strong><a href="http://www.arip.co.th" name="home">[เอ.อาร์.ไอ.พี, www.arip.co.th]</a></strong> iPhone 5S จะเพิ่มความละเอียดของจอแสดงผล ... เป็นข่าวรายวันจริงๆสำหรับอุปกรณ์รุ่นใหม่ของ Apple อย่าง iPhone 5S ที่มีการคาดหมายกันไว้ว่ามันจะเป็นฮาร์ดแวร์รุ่นใหม่ในตระกูล iPhone ตัวแรกที่เปิดตัวในปีนี้ พร้อมกับหลายสิ่งหลายอย่างที่เพิ่มขึ้นมาใน iPhone 5S</p>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p>พื้นที่โฆษณา&nbsp;&nbsp;<img src="http://www.arip.co.th/2006/images/ad/arrow_down.gif" /></p>\r\n\r\n<p>สนใจลงโฆษณา ติดต่อ โทร.0-2642-3400 ต่อ 4613</p>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p><img alt="" src="http://www.arip.co.th/images/news/2009/%E0%B8%82%E0%B9%88%E0%B8%B2%E0%B8%A7%202013/Apple%202013/new%20retina%20display%20iphone%205s.jpg" style="height:313px; width:500px" /></p>\r\n\r\n<p>เว็บไซต์ WeiPhone ของจีนได้รายงานว่า Apple กำลังมีความพยายามในการเพิ่มความละเอียดของหน้าจอแสดงผลใน<strong> iPhone 5S</strong> ให้มากกว่าจอ<strong> Retina Display </strong>บน <strong>iPhone 5</strong> ซึ่งจะมีการเพิ่มจำนวนพิกเซลจากเดิม 730,000 เป็น 1.5 ล้านพิกเซล ทำให้มีความหนาแน่นของพิกเซลบนหน้าจอขนาด 4 นิ้วนั้นมากขึ้น แหล่งข่าวยังระบุว่าการเพิ่มความละเอียดบนหน้าจอ iPhone 5S ทาง Apple อาจใช้เทคนิคเดียวกับที่ใช้ใน iPad mini ด้วยการขยายขอบจอแสดงผลให้ติดกับขอบตัวเครื่องมากขึ้น หากเป็นไปอย่างที่เว็บไซต์จีนอ้างไว้ก็อาจทำให้นักพัฒนาแอพพลิเคชั่นบน iOS ต้องรับภาระในการปรับความละเอียดของการแสดงผลให้เข้ากับจอแสดงผลใหม่ของ iPhone 5S<br />\r\n<br />\r\nจากข้อมูลดังกล่าวทำให้คิดได้ว่าการมาของสมาร์ทโฟนรุ่น ใหม่ๆ ที่ปรับความละเอียดของการแสดงผลมาที่ 1080p ส่งผลต่อ Apple พอสมควร การมีจอแสดงผลระดับ Retina Display ที่ให้ความคมชัดชนิดที่สายตาแทบแยกไม่ออกแล้วเป็นตัวชูโรงอาจไม่พอสำหรับ Apple อีกต่อไป ดังนั้นความเปลี่ยนแปลงที่จะมากับ iPhone 5S จึงเป็นสิ่งที่ Apple ต้องการทิ้งห่างคู่แข่งรายอื่นๆออกไป</p>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p><br />\r\n<strong>Tags:</strong> <a href="http://www.arip.co.th/tag/iphone+5s" target="_blank">iphone 5s</a> <a href="http://www.arip.co.th/tag/retina+display" target="_blank">retina display</a> <a href="http://www.arip.co.th/tag/apple" target="_blank">apple</a> <a href="http://www.arip.co.th/tag/iphone" target="_blank">iphone</a> <a href="http://www.arip.co.th/tag/%E0%B8%82%E0%B9%88%E0%B8%B2%E0%B8%A7%E0%B9%84%E0%B8%AD%E0%B8%97%E0%B8%B5" target="_blank">ข่าวไอที</a> <a href="http://www.arip.co.th/tag/arip" target="_blank">arip</a></p>\r\n', '2013-05-20 20:03:18', 1, 1, 0),
(9, 'เตือนระวังไข้ปวดข้อ “ชิคุนกุนยา” ระบาดพร้อมไข้เลือ', 'medmed01001.gif', '<h1>เตือนระวังไข้ปวดข้อ &ldquo;ชิคุนกุนยา&rdquo; ระบาดพร้อมไข้เลือดออก</h1>\r\n\r\n<p>โดย gidanan ganghair | วันที่ 17 พฤษภาคม 2556</p>\r\n\r\n<p><strong><img alt="" src="http://www.thaihealth.or.th/sites/default/files/users/user-16058/medmed01001.gif" style="height:145px; width:285px" /></strong></p>\r\n\r\n<p><strong>สธ.เตือนประชาชนระวังโรคไข้ปวดข้อ ยุงลายหรือ โรคชิคุนกุนยาจะกลับมาระบาดพร้อมโรคไข้เลือดออก หลังผลวิจัยพบว่าในหลายพื้นที่โดยเฉพาะ สตูล ชุมพร ตรัง สุราษฏร์ธานี ชลบุรี ฉะเชิงเทรา ยุงลายสวนติดเชื้อชิคุนกุนยาสูงถึงร้อยละ 39 ยุงบางตัวมีทั้งเชื้อไวรัสเดงกีและเชื้อไวรัสชิคุนกุนยาอยู่ในตัวเดียว และพบว่าไม่จำเป็นว่ายุงต้องไปกัดผู้ป่วยแล้วจึงจะมีเชื้อ วิธีป้องกันโรคได้ดีที่สุดคือการกำจัดแหล่งเพาะพันธุ์ยุงลายและการป้องกัน ไม่ให้ยุงกัด ทั้งกลางวันและกลางคืน</strong></p>\r\n\r\n<p><strong>นพ.นิพนธ์ โพธิ์พัฒนชัย อธิบดีกรมวิทยาศาสตร์การแพทย์</strong> เปิดเผยผลการวิจัย ของกรมวิทยาศาสตร์การแพทย์ กระทรวงสาธารณสุข ร่วมกับ คณะแพทยศาสตร์ จุฬาลงกรณ์มหาวิทยาลัย พบว่าในหลายพื้นที่โดยเฉพาะจังหวัดสตูล ชุมพร ตรัง สุราษฏร์ธานี ชลบุรี ฉะเชิงเทรา ยุงลายสวนติดเชื้อไวรัสชิคุนกุนยา (Chikungunya virus) สูงถึงร้อยละ 39 ยุงบางตัวติดเชื้อไวรัสทั้งสองชนิด ได้แก่ เชื้อไวรัสเดงกี (Dengue virus) ซึ่งทำให้เกิดไข้เลือดออก และเชื้อไวรัสชิคุนกุนยา หรือไข้ปวดข้อยุงลาย นอกจากนี้ความรู้ จากการวิจัยยังพบว่าไม่จำเป็นว่ายุงต้องไปกัดผู้ป่วยแล้วจึงจะมีเชื้อ และเชื้อไวรัสทั้งสองชนิดนี้ยังสามารถถ่ายทอดจากแม่ยุงไปยังลูกยุงได้ด้วย</p>\r\n\r\n<p>วิธีการป้องกันโรคได้ดีที่สุดคือการกำจัดแหล่งเพาะพันธุ์ยุงลาย ซึ่งส่วนใหญ่จะอยู่ในบริเวณบ้าน เช่น โอ่งเก็บน้ำฝนไม่มีฝาปิด อ่างเก็บน้ำในห้องน้ำ จานรองขาตู้กับข้าว แจกันบูชาพระ กระป๋อง ถ้วยน้ำหรือ แก้วพลาสติกที่ทิ้งไม่เป็นที่เป็นทางและมีน้ำขัง เศษขยะ กล่องโฟม รวมถึงยางรถยนต์เก่า เป็นต้น ด้วยวิธี การง่ายๆ เช่น คว่ำหรือปิดฝาภาชนะดังกล่าวให้สนิท ตรวจรอบๆ บ้านว่ามีแหล่งน้ำขังหรือไม่ หากมีต้องกำจัดการเก็บกวาดสิ่งปฏิกูลออกไป และอีกทางหนึ่งคือการป้องกันไม่ให้ยุงกัดทั้งกลางวันและกลางคืน ซึ่งแต่เดิมเข้าใจว่ายุงลายกัดเฉพาะเวลากลางวัน แต่ผลการวิจัยพบว่าปัจจุบันในบ้านเรายุงลายกัดไม่เลือกเวลา ปรับตัวตามพฤติกรรม ของคน และพบว่าอุณหภูมิบนยอดดอย ที่สูงขึ้นทำให้ยุงลายกัดบ่อยขึ้นและขยายพันธุ์ได้บนภูเขาสูง ต่างจากความรู้เดิมที่ว่ายุงลายบ้านไม่สามารถขยายพันธุ์ได้บนที่สูงเกิน 350 เมตร ดังนั้นอาจจะทำให้เกิดการระบาดของไข้ปวดข้อยุงลายและไข้เลือดออกในหมู่ชาว ดอย เพราะไม่เคยมีภูมิคุ้มกันมาก่อน</p>\r\n\r\n<p>นพ.นิพนธ์ กล่าวต่อว่า การป้องกันการกัดของยุง นอกจากใส่เสื้อผ้ามิดชิดแล้ว ต้องชโลม ยาทากันยุงให้ทั่วส่วนที่โผล่พ้นเสื้อผ้า เพราะกลไกการป้องกันยุงของสารทาป้องกันยุงที่สำคัญ คือ ปกป้องบริเวณที่ทาไม่ให้ยุงหาเป้าหมายเจอ ส่วนบริเวณผิวหนังใกล้เคียงซึ่งไม่ได้ทายาจะไม่ถูกปกป้อง ซึ่งสารออกฤทธิ์ที่ป้องกันยุงกัดได้ดีที่สุดและมีอายุการใช้งานยาวนานในการ เก็บมากที่สุดจนถึงขณะนี้คือ สารดีทหรือ ไดเอททิล โทลูเอไมด์ ที่มีความเข้มข้นร้อยละ 15-30 โดยน้ำหนัก ซึ่งจะป้องกันการกัดของยุงทั้งกลางวันและกลางคืนได้ 4-7 ชั่วโมงขึ้นอยู่กับตำรับ บุคคล และสิ่งแวดล้อมบริเวณที่ใช้ องค์การอนามัยโลกจึงแนะนำให้ใช้ป้องกันโรค ที่ระบาดโดยแมลง รองลงมาจากดีท คือ สารออกฤทธิ์ที่เหมาะสำหรับใช้กับเด็กเล็กต่ำกว่าสี่ขวบ ซึ่งเป็นสารสังเคราะห์เลียนแบบกรดอะมิโนจากธรรมชาติ คือ ไออาร์ 3535 หรือเอททิลบิวทิลอะซิติลอะมิโนโปรปิโอเนท โดยองค์กรพิทักษ์สิ่งแวดล้อมแห่งประเทศสหรัฐอเมริกา (United States Environmental Protection Agency) หรือยูเอสอีพีเอ อนุญาตให้ใช้ในเด็กได้ตั้งแต่อายุหกเดือน แต่ในประเทศไทย โดยสำนักงานคณะกรรมการอาหารและยา (อย.) ให้ใช้ได้ตั้งแต่สองขวบขึ้นไป</p>\r\n\r\n<p>สำหรับน้ำมันหอมระเหยจากสมุนไพรต้องทาซ้ำทุกครึ่งชั่วโมง สำหรับป้องกันการกัดของยุงลายหรือ ยุงน้ำกร่อย และทาซ้ำทุก 2-3 ชั่วโมง สำหรับการป้องกันการกัดของยุงกลางคืน ทั้งนี้ขึ้นอยู่กับตำรับ ที่แต่ละแหล่งผลิต และในการใช้ผลิตภัณฑ์ทาป้องกันยุงหากรู้สึกร้อนผิวให้ล้างออกด้วยสบู่และน้ำ สะอาด และเปลี่ยนไปใช้ผลิตภัณฑ์แผ่นไล่ยุงชนิดแมท ซึ่งใช้คู่กับอุปกรณ์เสียบไฟฟ้า เนื่องจากบางคนผิวจะไวต่อการแพ้ แต่ควรใช้ในที่ซึ่งอากาศถ่ายเทได้ ซึ่งจะปกป้องการกัดได้ประมาณร้อยละ 80-90</p>\r\n\r\n<p><strong>นพ.สมชาย แสงกิจพร ผู้อำนวยการสถาบันวิจัยวิทยาศาสตร์สาธารณสุขกรมวิทยาศาสตร์การแพทย์ </strong>กล่าว เพิ่มเติมว่า การเฝ้าระวังระดับพันธุกรรมของเชื้อไวรัสชิคุนกุนยา พบว่าขณะนี้มีทั้งสายพันธุ์แอฟริกาที่กลายพันธุ์และสายพันธุ์เอเชียดั้งเดิม คนไทยบางคนและนักท่องเที่ยว ส่วนใหญ่ที่ยังไม่มีภูมิคุ้มกันต่อเชื้อไวรัสชิคุนกุนยา จึงเสี่ยงต่อการป่วยด้วยโรคนี้ แม้ว่าจะไม่ทำให้ตายเหมือนไข้เลือดออก แต่ความทรมานจากการปวดข้อรุนแรงและไม่หายขาด บางรายปวดข้อเป็นปีก็ยังไม่หายและ แม่ที่กำลังตั้งครรภ์ที่ได้รับเชื้อสามารถถ่ายทอดไปสู่ทารกได้ ทำให้ทารกเกิดใหม่มีไข้ มีผื่น ไม่ค่อยขยับตัว และหายใจเร็ว ต้องการการดูแลเป็นพิเศษ จึงไม่ควรซื้อยามารับประทานเอง แต่ให้ไปที่สถานบริการสาธารณสุข จะได้เข้าสู่ระบบการเฝ้าระวังโรคและให้การรักษาที่ถูกต้อง</p>\r\n\r\n<p>เนื่องจากอาการของโรคไข้ปวดข้อยุงลายหรือโรคชิคุนกุนยามีลักษณะคล้ายกับ โรคไข้เลือดออก การตรวจรักษาของแพทย์จำเป็นต้องอาศัยผลการตรวจชันสูตรทางห้องปฏิบัติการ เพื่อเป็นเครื่องมือยืนยันว่าผู้ป่วยเป็นโรคอะไร กรมวิทยาศาสตร์การแพทย์ ได้พัฒนาศักยภาพระบบการตรวจวิเคราะห์เชื้อไวรัส ชิคุนกุนยาและเชื้อไวรัสเดงกีทางห้องปฏิบัติการ รวมทั้งดำเนินการเฝ้าระวังโรคทางห้องปฏิบัติการ ทั้งในส่วนกลางและส่วนภูมิภาค ให้สามารถรายงานผล ได้อย่างรวดเร็วและมีความถูกต้อง แม่นยำ โดยเฉพาะ ในรายเร่งด่วนสามารถตรวจวิเคราะห์และรายงานผลได้ภายใน 24 ชั่วโมง ซึ่งเป็นผลดีต่อแนวทางการรักษาผู้ป่วยและการควบคุมโรคได้อย่างมีประสิทธิภาพ มากยิ่งขึ้น ดังนั้น โรงพยาบาลของรัฐหรือเอกชนทั่วประเทศ สามารถส่งตัวอย่างของผู้ป่วยมาตรวจวิเคราะห์ได้ที่ สถาบันวิจัยวิทยาศาสตร์สาธารณสุข กรมวิทยาศาสตร์การแพทย์หรือในส่วนภูมิภาคส่งตรวจได้ที่ศูนย์วิทยาศาสตร์การ แพทย์ 14 แห่งทั่วประเทศ ได้แก่ เชียงใหม่ เชียงราย พิษณุโลกนครสวรรค์ สมุทรสงคราม ชลบุรี ขอนแก่น อุดรธานี นครราชสิมา อุบลราชธานี สุราษฏร์ธานี ภูเก็ต สงขลา และตรัง</p>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p><strong>ที่มา : </strong>หนังสือพิมพ์ ASTVผู้จัดการ</p>\r\n', '2013-05-20 20:03:18', 1, 1, 0),
(11, 'ภูมิแพ้อาหาร', 'htc.jpg', '<p><strong>ภูมิแพ้อาหาร</strong></p>\r\n\r\n<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>การแพ้อาหาร</strong> ถือเป็นโรคภูมิแพ้ประเภทหนึ่งที่พบมาก&nbsp; นอกเหนือจากโรคภูมิแพ้ผิวหนัง&nbsp; แพ้อากาศ&nbsp; หรือหอบหืด&nbsp; มีรายงานจากสหรัฐอเมริกา&nbsp; พบว่า &nbsp;ประชากรมากกว่า ๑๒ ล้านคนเป็นโรคภูมิแพ้อาหารและเกิดขึ้นในเด็กประมาณ ๓ ล้านคน&nbsp;&nbsp; จึงเห็นได้ว่าโรคนี้เกิดขึ้นมานานหลายสิบปี&nbsp; และมีแนวโน้มเพิ่มขึ้นเรื่อย ๆ ทั้งเด็กและผู้ใหญ่&nbsp;&nbsp; เนื่องจากการการใช้ชีวิตและสิ่งแวดล้อมรอบ ๆ ตัวที่เปลี่ยนแปลงไป&nbsp;&nbsp;&nbsp; สำหรับประเทศไทยมีแนวโน้มเด็กเป็นภูมิแพ้อาหารเพิ่มมากขึ้นจากอาหารบางชนิด&nbsp; ได้แก่&nbsp; นมวัว&nbsp; ไข่&nbsp; และแป้งสาลี&nbsp; โดยเฉพาะขวบปีแรกอาจมีระดับการแพ้สูงขึ้นช่วงระยะหนึ่ง&nbsp; แต่หลังจาก ๒ - ๓ ขวบจะดีขึ้นเรื่อย ๆ&nbsp; และอาจหายแพ้ได้เมื่อโตขึ้น&nbsp; หรือแพ้น้อย</p>\r\n\r\n<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>สาเหตุ</strong>ของโรคภูมิแพ้อาหาร&nbsp;เกิดจากการที่ร่างกายตอบสนองต่อสารหรือส่วนประกอบในอาหารแตกต่างไปจากปกติ&nbsp; นอกจากนั้นยังพบว่าหนึ่งในปัจจัยเสี่ยงที่ทำให้เป็นมากขึ้นและพบตั้งแต่เด็ก ๆ คือสาเหตุทางพันธุกรรม&nbsp; เช่น&nbsp; กรณีที่พ่อหรือแม่มีประวัติเป็นภูมิแพ้&nbsp; หรือหากพบลูกคนแรกแพ้อาหาร&nbsp; ลูกคนถัดไปมีแนวโน้มเป็นโรคภูมิแพ้ได้เช่นกัน&nbsp;เพียงแต่ไม่จำเป็นว่าต้องเป็นโรคภูมิแพ้ประเภทเดียวกัน&nbsp; หรืออาหารชนิดเดียวกัน&nbsp; สำหรับปัจจัยอื่น ๆ ที่อาจจะส่งผลให้เกิดการแพ้อาหาร&nbsp; ได้แก่</p>\r\n\r\n<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>พันธุกรรม</strong>&nbsp; เป็นปัจจัยที่หลีกเลี่ยงไม่ได้&nbsp; รวมถึงเพศของเด็ก</p>\r\n\r\n<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>การคลอด&nbsp; </strong>มีงานวิจัยพบว่า&nbsp; <strong>เด็กที่คลอดโดยการผ่ามีความเป็นไปได้ที่จะแพ้อาหารมากกว่าเด็กที่เกิดจากการคลอดธรรมชาติ</strong>เพราะ ขณะที่เด็กคลอดผ่านทางช่องคลอดเด็กจะได้รับจุลินทรีย์ที่มีประโยชน์เข้าไปใน ทางเดินอาหาร โดยได้รับจากแม่หรือสภาพแวดล้อมทำให้เด็กมีภูมิคุ้มกันทางระบบทางเดินอาหาร และลำไส้แข็งแรงกว่า &nbsp; สำหรับเด็กที่ไม่ได้คลอดธรรมชาติแต่คลอดโดยผ่าออกมาทางหน้าท้อง&nbsp; &nbsp;เด็กก็จะไม่ได้รับจุลินทรีย์นี้จากแม่ระหว่างคลอด</p>\r\n\r\n<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>ช่วงให้นมบุตร&nbsp;&nbsp; </strong>ลูกจะได้รับสารอาหารจากน้ำนมแม่&nbsp;&nbsp; หากแม่ไม่ระมัดระวังการกินอาหารหรือกินสิ่งใดมากเกินไป&nbsp; สารนั้นก็อาจไปกระตุ้นให้เด็กก่อภูมิแพ้ได้</p>\r\n\r\n<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>สิ่งแวดล้อม</strong>&nbsp; เด็กไม่จำเป็นต้องแพ้อาหารตั้งแต่เกิด&nbsp; อาจ พบการแพ้อาหารบางชนิดเมื่อเด็กโตขึ้นก็ได้&nbsp;&nbsp; นอกเหนือจากเรื่องของภูมิคุ้มกันของร่างกายของเด็กแล้ว&nbsp;&nbsp; ส่วนหนึ่งอาจเกิดจากสภาวะแวดล้อมที่เติบโต</p>\r\n\r\n<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; นอกจากนี้ยังพบว่า&nbsp; ปัจจุบันเด็กมีภาวะขาดวิตามินดีได้ง่าย&nbsp; อาจเกิดจากวิถีชีวิตที่อยู่แต่ห้องสี่เหลี่ยมตามอาคารชุด&nbsp; ห่างไกลธรรมชาติ&nbsp; ทำให้เด็กสัมผัสแสงแดดน้อยลง&nbsp; มีโอกาสสร้างวิตามินดีลดลง&nbsp; ทำให้เกิดถูมิแพ้ได้ง่ายขึ้นเพราะภูมิต้านทานไม่แข็งแรง</p>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p><strong>ด้วยความปรารถนาดีจาก .... กลุ่มงานสุขศึกษา&nbsp;&nbsp;&nbsp; โรงพยาบาลลำปาง</strong></p>\r\n\r\n<p><strong>E - mail&nbsp; address&nbsp; <a href="mailto:Health.edlph@gmail.com">Health.edlph@gmail.com</a></strong></p>\r\n', '2013-05-22 22:08:44', 1, 1, 0),
(12, 'iphone 6', 'untitled-5.jpg', '<p><strong>อั้ยย่ะ <a href="http://hitech.sanook.com/mobile/" target="_blank">iPhone</a> 6 และ iPhone Mini คอนเซ็ปใหม่ล่าสุด!!</strong></p>\r\n\r\n<p><strong><a href="http://hitech.sanook.com/search/iPhone%206" target="_blank">iPhone 6</a>, iPhone Mini</strong>- มีข่าวลือเกี่ยวกับ <strong>iPhone</strong> รุ่นใหม่อย่าง <strong><a href="http://hitech.sanook.com/tag/iphone%205/" target="_blank">iPhone 5</a>S, <a href="http://hitech.sanook.com/search/iPhone%206" target="_blank">iPhone 6</a>, iPhone Mini (iPhone low cost)</strong> กำลังมีออกมาอย่างต่อเนื่องยิ่งใกล้วันเปิดตัวในเดือนมิถุนายน 2013 &ndash; ใน<strong>งาน WWDC 2013</strong> แอปเปิล ข่าวก็จะพร้อมใจกันหลุดออกมา!!</p>\r\n\r\n<p><img src="http://p.s1sf.com/hi/0/ud/271/1357628/untitled-20.jpg" style="height:675px; width:450px" /></p>\r\n\r\n<p>อย่างล่าสุดที่เว็บไซต์ www.behance.net ได้นำเสนอคอนเซ็ปของ&nbsp;<strong> <a href="http://hitech.sanook.com/search/iPhone%206" target="_blank">iPhone 6</a>, iPhone Mini (iPhone low cost)</strong> ใหม่ล่าสุดออกมาสวยงามไม่เบาครับ เพราะคอนเซ็ปที่เราเห็นล่าสุดนั้นมันถูกออกแบบใหม่ด้วยฝีมือของ JohnnyPlaid นักออกแบบจาก Los Angeles</p>\r\n\r\n<p><img src="http://p.s1sf.com/hi/0/ud/271/1357628/untitled-21.jpg" style="height:675px; width:450px" /></p>\r\n\r\n<p>สำหรับ <strong>iPhone 6, iPhone Mini </strong>ที่เราเห็นในข่าวนั้นจะ ไม่มีขอบของหน้าจอ(โดนใจผมนะแบบนี้) นอกจากนี้การออกแบบสุดอลังการณ์ที่เราได้เห็นแล้ว JohnnyPlaid ยังเพิ่มเติมในส่วนของ สเปค มาให้เราด้วยลอง</p>\r\n\r\n<p><img src="http://p.s1sf.com/hi/0/ud/271/1357628/untitled-5.jpg" style="height:641px; width:427px" /></p>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p>เรียกได้ว่า Apple เป็นแบรนด์ที่ไม่ต้องทุ่มงบประมาณมหาศาลในการโปรโมทสินค้าเหมือนเจ้าอื่นๆ แค่ข่าวหลุด ที่ออกมาให้เราเสพทุกวันก็พอแล้ว!! มาดูกันว่าครับว่าภาพคอนเซ็ปของ iPhone 6 ที่ว่านี้จะสวยงามขนาดไหน</p>\r\n\r\n<p><img src="http://p.s1sf.com/hi/0/ud/271/1357628/untitled-18.jpg" style="height:431px; width:600px" /></p>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p>อ้างอิงจาก: behance.net</p>\r\n\r\n<p>ติดตามข่าวความเคลื่อนไหวของเทคโนโลยีรอบโลกได้ที่นี่ &gt;&gt;&gt;<a href="http://hitech.sanook.com/" target="_blank">&nbsp;</a><a href="http://hitech.sanook.com/" target="_blank">www.hitech.sanook.com</a></p>\r\n', '2013-05-23 23:09:31', 1, 1, 0),
(13, 'Apple’s Commitment to Customer Privacy', 'apple-logo-645x250.jpg', '<p><a href="http://www.macthai.com/wp-content/uploads/2013/06/apple-logo-645x250.jpg"><img alt="apple-logo-645x250" src="http://www.macthai.com/wp-content/uploads/2013/06/apple-logo-645x250.jpg" style="height:250px; width:645px" /></a></p>\r\n\r\n<p>ช่วงนี้โลกไอทีที่อเมริกามีประเด็นร้อนแรงมาก คือเรื่อง<a href="http://www.blognone.com/node/45095">โครงการ PRISM</a> ที่รัฐบาลสหรัฐแอบดักฟังข้อมูลของผู้ใช้ไป โดยมีบริษัทที่ร่วมโครงการนี้มากมาย ไม่ว่าจะเป็น Apple, Microsoft, Google, Facebook ซึ่งล่าสุดทางแอปเปิลได้ออกจดหมายเปิดผนึกชี้แจงเรื่องดังกล่าวแล้ว<br />\r\nโดยแอปเปิลระบุว่า บริษัทได้รับการร้องขอข้อมูลบางอย่างของผู้ใช้จากทางรัฐบาลจำนวน 4,000-5,000 ครั้ง ซึ่งมีความเกี่ยวโยงกับอุปกรณ์ 9,000 &ndash; 10,000 ชิ้น โดยการร้องขอทั้งหมดนั้นเพื่อใช้ในการค้นหาอาชญากร, การโจรกรรม และค้นหาคนหาย ซึ่งแอปเปิลได้ให้ฝ่ายกฏหมายตรวจสอบการร้องขอทุกครั้ง ก่อนที่จะส่งข้อมูลกลับไปให้ทางรัฐบาล</p>\r\n\r\n<p>ประเด็นสำคัญคือแอปเปิลย้ำว่าไม่ได้มีการเปิดช่องให้รัฐบาลสามารถเข้าถึงข้อมูลผู้ใช้ได้โดยตรง อย่างที่หลายสำนักข่าวเสนอก่อนหน้านี้</p>\r\n\r\n<p>Microsoft เองก็ได้เปิดเผยว่ามีการร้องขอในลักษณะเดียวกับแอปเปิลอยู่ที่&nbsp;6,000-7,000 ครั้งในรอบ 6 เดือน ส่วน Facebook ถูกร้องขอข้อมูลผู้ใช้ไปกว่า 19,000 account</p>\r\n\r\n<p>นอกจากนี้แอปเปิลเปิดเผยเพิ่มเติมว่า บริการหลายอย่างของแอปเปิลนั้นมีการเข้ารหัสจากทางผู้ใช้ทั้ง 2 ทางเช่น iMessage และ Facetime นั่นหมายถึงว่าแม้แต่แอปเปิลก็ไม่สามารถเปิดอ่านข้อมูลนี้ได้ รวมไปถึงบริการอย่าง Maps, Location, Siri ก็จะถูกเก็บในลักษณะที่ไม่สามารถเข้าถึงข้อมูลที่แท้จริงได้เช่นกัน</p>\r\n\r\n<p>ที่มา &ndash; <a href="http://www.apple.com/apples-commitment-to-customer-privacy/">Apple</a>, <a href="http://thenextweb.com/apple/2013/06/17/apple-says-it-received-4000-5000-data-requests-from-us-officials-in-last-6-months/">The Next Web</a></p>\r\n', '2013-06-17 17:05:56', 1, 1, 1),
(15, 'testing  clearos', '01-04-2013.jpg', '<p><a href="http://www.macthai.com/wp-content/uploads/2013/06/apple-logo-645x250.jpg"><img alt="apple-logo-645x250" src="http://www.macthai.com/wp-content/uploads/2013/06/apple-logo-645x250.jpg" style="height:250px; width:645px" /></a></p>\r\n\r\n<p>ช่วงนี้โลกไอทีที่อเมริกามีประเด็นร้อนแรงมาก คือเรื่อง<a href="http://www.blognone.com/node/45095">โครงการ PRISM</a> ที่รัฐบาลสหรัฐแอบดักฟังข้อมูลของผู้ใช้ไป โดยมีบริษัทที่ร่วมโครงการนี้มากมาย ไม่ว่าจะเป็น Apple, Microsoft, Google, Facebook ซึ่งล่าสุดทางแอปเปิลได้ออกจดหมายเปิดผนึกชี้แจงเรื่องดังกล่าวแล้ว<br />\r\nโดยแอปเปิลระบุว่า บริษัทได้รับการร้องขอข้อมูลบางอย่างของผู้ใช้จากทางรัฐบาลจำนวน 4,000-5,000 ครั้ง ซึ่งมีความเกี่ยวโยงกับอุปกรณ์ 9,000 &ndash; 10,000 ชิ้น โดยการร้องขอทั้งหมดนั้นเพื่อใช้ในการค้นหาอาชญากร, การโจรกรรม และค้นหาคนหาย ซึ่งแอปเปิลได้ให้ฝ่ายกฏหมายตรวจสอบการร้องขอทุกครั้ง ก่อนที่จะส่งข้อมูลกลับไปให้ทางรัฐบาล</p>\r\n\r\n<p>ประเด็นสำคัญคือแอปเปิลย้ำว่าไม่ได้มีการเปิดช่องให้รัฐบาลสามารถเข้าถึงข้อมูลผู้ใช้ได้โดยตรง อย่างที่หลายสำนักข่าวเสนอก่อนหน้านี้</p>\r\n\r\n<p>Microsoft เองก็ได้เปิดเผยว่ามีการร้องขอในลักษณะเดียวกับแอปเปิลอยู่ที่&nbsp;6,000-7,000 ครั้งในรอบ 6 เดือน ส่วน Facebook ถูกร้องขอข้อมูลผู้ใช้ไปกว่า 19,000 account</p>\r\n\r\n<p>นอกจากนี้แอปเปิลเปิดเผยเพิ่มเติมว่า บริการหลายอย่างของแอปเปิลนั้นมีการเข้ารหัสจากทางผู้ใช้ทั้ง 2 ทางเช่น iMessage และ Facetime นั่นหมายถึงว่าแม้แต่แอปเปิลก็ไม่สามารถเปิดอ่านข้อมูลนี้ได้ รวมไปถึงบริการอย่าง Maps, Location, Siri ก็จะถูกเก็บในลักษณะที่ไม่สามารถเข้าถึงข้อมูลที่แท้จริงได้เช่นกัน</p>\r\n\r\n<p>ที่มา &ndash; <a href="http://www.apple.com/apples-commitment-to-customer-privacy/">Apple</a>, <a href="http://thenextweb.com/apple/2013/06/17/apple-says-it-received-4000-5000-data-requests-from-us-officials-in-last-6-months/">The Next Web</a></p>\r\n', '2013-06-17 17:06:04', 1, 1, 0);

-- --------------------------------------------------------

--
-- Table structure for table `tb_relation_person`
--

CREATE TABLE IF NOT EXISTS `tb_relation_person` (
  `id_tb_relation_person` int(11) NOT NULL AUTO_INCREMENT,
  `id_tb_person` int(11) NOT NULL,
  `address_origin` varchar(50) DEFAULT NULL,
  `telephone` varchar(12) DEFAULT NULL,
  `address_in_thai` varchar(50) DEFAULT NULL,
  `friend` varchar(20) DEFAULT NULL,
  `phone_friend` varchar(12) DEFAULT NULL,
  `relative_address` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`id_tb_relation_person`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=10 ;

--
-- Dumping data for table `tb_relation_person`
--

INSERT INTO `tb_relation_person` (`id_tb_relation_person`, `id_tb_person`, `address_origin`, `telephone`, `address_in_thai`, `friend`, `phone_friend`, `relative_address`) VALUES
(1, 1, 'Myintgyinar, Myitkyina, Myitkyinar\r\n						', '0863212345', ' บึงกุ่ม กรุงเทพมหานคร\r\n						', 'Micle anglelo', '0867546321', 'ต.ลำลูกกา อ.เมือง จ.ปทุมธานี'),
(2, 2, 'Myintgyinar, Myitkyina, Myitkyinar\r\n						', '0863212345', ' บึงกุ่ม กรุงเทพมหานคร\r\n						', 'Micle anglelo', '0867546321', 'ต.ลำลูกกา อ.เมือง จ.ปทุมธานี'),
(8, 4, 'Myintgyinar, Myitkyina, Myitkyinar\r\n						', '0863212345', ' บึงกุ่ม กรุงเทพมหานคร\r\n						', 'Micle anglelo', '0867546321', 'ต.ลำลูกกา อ.เมือง จ.ปทุมธานี'),
(7, 2, 'Myintgyinar, Myitkyina, Myitkyinar\r\n						', '0863212345', ' บึงกุ่ม กรุงเทพมหานคร\r\n						', 'Micle anglelo', '0867546321', 'ต.ลำลูกกา อ.เมือง จ.ปทุมธานี'),
(9, 7, 'Kyaiensaekyi,Kayin State, Myanmar\n						', '0816978801', '121 ซงเทียนทะเล 26 แขวงท่าข้าม เขตบางขุนเทียน กรุง', 'Micle anglelo', '', 'ต.ลำลูกกา อ.เมือง จ.ปทุมธานี');
...
CREATE TABLE IF NOT EXISTS `tb_talent` (
  `id_tb_talent` int(11) NOT NULL AUTO_INCREMENT,
  `id_tb_person` int(11) NOT NULL,
  `communication_skills` varchar(50) DEFAULT NULL,
  `other` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`id_tb_talent`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=10 ;
...
INSERT INTO `tb_talent` (`id_tb_talent`, `id_tb_person`, `communication_skills`, `other`) VALUES
(6, 4, '2', 'พูดภาษาอังกฤษได้'),
(8, 1, '1', 'พูดภาษาอังกฤษได้'),
(9, 1, '2', 'พูดภาษาอังกฤษได้');

-- --------------------------------------------------------

--
-- Table structure for table `tb_titlepicture`
--

CREATE TABLE IF NOT EXISTS `tb_titlepicture` (
  `id_titlepicture` int(11) NOT NULL AUTO_INCREMENT,
  `titlepicture` text NOT NULL,
  `folder_picture` varchar(30) NOT NULL,
  `pathlink` varchar(70) NOT NULL,
  `thumpic` text NOT NULL,
  PRIMARY KEY (`id_titlepicture`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=4 ;

--
-- Dumping data for table `tb_titlepicture`
--

INSERT INTO `tb_titlepicture` (`id_titlepicture`, `titlepicture`, `folder_picture`, `pathlink`, `thumpic`) VALUES
(1, 'การแข่งขันฮูลาฮูปมาราธอน นัดล้างตา วันที่ 25 ธ.ค. 55 ณ สวนธรรมธาริน', 'photo1', 'index.php/home/path_photo/1', 'DSC_0100re.jpg'),
(2, 'ภาพงานมหกรรมสร้างเสริมสุขภาพ ครั้งที่ 4 วันที่ 21-22 ส.ค. 55', 'photo2', 'index.php/home/path_photo/2', '384884_10150575702542152_992553291_n (1).jpg'),
(3, 'walk rally', 'photo2', 'index.php/home/path_photo/3', '432313_10151382070421844_438441696_n.jpg');
...
CREATE TABLE IF NOT EXISTS `tb_user` (
  ...
  `id_card` varchar(11) NOT NULL DEFAULT '0',
  `address` varchar(50) DEFAULT NULL,
  `date_record` datetime DEFAULT NULL,
  `addby_user` int(10) NOT NULL,
  PRIMARY KEY (`id_user`)
...
INSERT INTO `tb_user` (`id_user`, `user`, `password`, `birthday`, `name`, `lastname`, `email`, `user_enable`, `level_user`, `id_card`, `address`, `date_record`, `addby_user`) VALUES
(1, 'admin', '81dc9bdb52d04dc20036dbd8313ed055', '1983-05-18', 'jutturong', 'charoenrit', 'basic.soft@hotmail.com', 1, 1, '11111111111', 'khonkaen', '2013-05-20 02:10:12', 0),
(2, 'user1', '81dc9bdb52d04dc20036dbd8313ed055', '1998-01-13', 'user1', 'user1', 'user1@gmail.com', 1, 2, '0', NULL, '2014-01-14 21:23:30', 1);

-- --------------------------------------------------------

--
-- Table structure for table `tb_visa`
--

CREATE TABLE IF NOT EXISTS `tb_visa` (
  `id_visa` int(11) NOT NULL AUTO_INCREMENT,
  `id_tb_person` int(11) NOT NULL,
  `date_visa_expire_begin` date DEFAULT NULL,
  `count_date_visa` int(3) DEFAULT NULL,
  `place_visa` varchar(50) DEFAULT NULL,
  `date_visa_expire` date DEFAULT NULL,
...
--
-- Dumping data for table `tb_visa`
--

INSERT INTO `tb_visa` (`id_visa`, `id_tb_person`, `date_visa_expire_begin`, `count_date_visa`, `place_visa`, `date_visa_expire`, `date_visa`, `date_report`) VALUES
(6, 4, '2014-02-03', 30, 'พระโขนง', '2014-02-11', '2014-02-20', '2014-02-25'),
(7, 4, '2014-02-10', 18, 'พระโขนง', '2014-02-28', NULL, NULL),
(8, 4, '2014-02-10', 18, 'พระโขนง', '2014-02-28', NULL, NULL),
(9, 0, NULL, 0, 'พระโขนง', NULL, NULL, NULL),
(10, 0, NULL, 0, 'พระโขนง', NULL, NULL, NULL),
(11, 3, NULL, 0, 'พระโขนง', NULL, NULL, NULL),
(12, 4, '2014-02-02', 25, 'พระโขนง', '2014-02-27', '2014-02-18', '2014-02-26'),
(13, 3, '2014-02-03', 23, 'พระโขนง', '2014-02-26', '2014-02-11', '2014-02-10'),
(14, 1, '2014-04-01', 1101, 'พระโขนง', '2017-04-06', '2014-04-24', '2014-04-24'),
(15, 7, '2014-10-25', 729, '', '2012-10-26', NULL, '2014-07-22');

-- --------------------------------------------------------

--
-- Table structure for table `tb_vision`
--

CREATE TABLE IF NOT EXISTS `tb_vision` (
  `id_tb_vision` int(11) NOT NULL AUTO_INCREMENT,
  `content_vision` text COLLATE utf8_bin,
  `DMY_vision` datetime DEFAULT NULL,
  `enable_vision` int(1) DEFAULT NULL,
  `id_user` int(11) DEFAULT NULL,
  PRIMARY KEY (`id_tb_vision`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=2 ;

--
-- Dumping data for table `tb_vision`
--

INSERT INTO `tb_vision` (`id_tb_vision`, `content_vision`, `DMY_vision`, `enable_vision`, `id_user`) VALUES
(1, '<div class="art-layout-cell layout-item-3" style="width: 33%" >\r\n        <b>วิสัยทัศน์ (Vision)</b>\r\n        <p style="color:#FFFFFF; font-size:15px;">"เป็นหน่วยงานชั้นนำที่มีคุณภาพ สร้างสังคมสุขภาวะอย่างยั่งยืน"</p>\r\n     \r\n        <b>พันธกิจ (Mission)</b>\r\n         <p style="color:#FFFFFF; font-size:15px;">\r\n                    1. ให้บริการระดับปฐมภูมิ ทุติยภูมิ/ตติยภูมิ\r\n                    <br>\r\n                    2. ให้บริการระดับความเชี่ยวชาญระดับสูง 4 สาขา ได้แก่สาขาอุบัติเหตุ สาขามะเร็ง สาขาหัวใจ และสาขาทารกแรกเกิด\r\n                    <br>\r\n                    3. พัฒนาระบบบริหารจัดการให้มีประสิทธิภาพ\r\n                    <br>\r\n                    4. ร่วมผลิตและพัฒนาบุคลากรด้านการแพทย์และสาธารณสุข\r\n         </p>\r\n       \r\n </div>', '2013-06-04 04:04:18', 1, 1);
